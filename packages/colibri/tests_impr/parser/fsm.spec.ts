...
init();
const lang_list = [HDL_LANG.VHDL, HDL_LANG.VERILOG];
...
async function parse_fsm(lang: HDL_LANG, test_index: number) {
...
function check_test(test_index: number, lang: HDL_LANG) {
