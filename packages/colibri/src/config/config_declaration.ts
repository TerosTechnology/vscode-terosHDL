...
export function get_config_from_json(json_config: any): e_config {
    ...
    const current_value_72 = json_config['tools']['general']['execution_mode'];
    if ( current_value_72 === "gui"){
        default_config['tools']['general']['execution_mode'] = e_tools_general_execution_mode.gui;
    }
    if ( current_value_72 === "cmd"){
        default_config['tools']['general']['execution_mode'] = e_tools_general_execution_mode.cmd;
    }
            
    // tools -> general -> waveform_viewer
    const current_value_73 = json_config['tools']['general']['waveform_viewer'];
    if ( current_value_73 === "tool"){
        default_config['tools']['general']['waveform_viewer'] = e_tools_general_waveform_viewer.tool;
    }
    if ( current_value_73 === "gtkwave"){
        default_config['tools']['general']['waveform_viewer'] = e_tools_general_waveform_viewer.gtkwave;
    }
            
    // tools -> osvvm -> installation_path
    const current_value_74 = json_config['tools']['osvvm']['installation_path'];
    if (typeof current_value_74 === 'string'){
        default_config['tools']['osvvm']['installation_path'] = current_value_74;
    }
            
    // tools -> osvvm -> tclsh_binary
    const current_value_75 = json_config['tools']['osvvm']['tclsh_binary'];
    if (typeof current_value_75 === 'string'){
        default_config['tools']['osvvm']['tclsh_binary'] = current_value_75;
    }
            
    // tools -> osvvm -> simulator_name
    const current_value_76 = json_config['tools']['osvvm']['simulator_name'];
    if ( current_value_76 === "activehdl"){
        default_config['tools']['osvvm']['simulator_name'] = e_tools_osvvm_simulator_name.activehdl;
    }
    if ( current_value_76 === "ghdl"){
        default_config['tools']['osvvm']['simulator_name'] = e_tools_osvvm_simulator_name.ghdl;
    }
    if ( current_value_76 === "nvc"){
        default_config['tools']['osvvm']['simulator_name'] = e_tools_osvvm_simulator_name.nvc;
    }
    if ( current_value_76 === "rivierapro"){
        default_config['tools']['osvvm']['simulator_name'] = e_tools_osvvm_simulator_name.rivierapro;
    }
    if ( current_value_76 === "questa"){
        default_config['tools']['osvvm']['simulator_name'] = e_tools_osvvm_simulator_name.questa;
    }
    if ( current_value_76 === "modelsim"){
        default_config['tools']['osvvm']['simulator_name'] = e_tools_osvvm_simulator_name.modelsim;
    }
    if ( current_value_76 === "vcs"){
        default_config['tools']['osvvm']['simulator_name'] = e_tools_osvvm_simulator_name.vcs;
    }
    if ( current_value_76 === "xsim"){
        default_config['tools']['osvvm']['simulator_name'] = e_tools_osvvm_simulator_name.xsim;
    }
    if ( current_value_76 === "xcelium"){
        default_config['tools']['osvvm']['simulator_name'] = e_tools_osvvm_simulator_name.xcelium;
    }
            
    // tools -> ascenlint -> installation_path
    const current_value_77 = json_config['tools']['ascenlint']['installation_path'];
    if (typeof current_value_77 === 'string'){
        default_config['tools']['ascenlint']['installation_path'] = current_value_77;
    }
            
    // tools -> ascenlint -> ascentlint_options
    const current_value_78 = json_config['tools']['ascenlint']['ascentlint_options'];
    if (Array.isArray(current_value_78)){
        default_config['tools']['ascenlint']['ascentlint_options'] = current_value_78;
    }
            
    // tools -> cocotb -> installation_path
    const current_value_79 = json_config['tools']['cocotb']['installation_path'];
    if (typeof current_value_79 === 'string'){
        default_config['tools']['cocotb']['installation_path'] = current_value_79;
    }
            
    // tools -> cocotb -> simulator_name
    const current_value_80 = json_config['tools']['cocotb']['simulator_name'];
    if ( current_value_80 === "icarus"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.icarus;
    }
    if ( current_value_80 === "verilator"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.verilator;
    }
    if ( current_value_80 === "vcs"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.vcs;
    }
    if ( current_value_80 === "riviera"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.riviera;
    }
    if ( current_value_80 === "activehdl"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.activehdl;
    }
    if ( current_value_80 === "questa"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.questa;
    }
    if ( current_value_80 === "modelsim"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.modelsim;
    }
    if ( current_value_80 === "ius"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.ius;
    }
    if ( current_value_80 === "xcelium"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.xcelium;
    }
    if ( current_value_80 === "ghdl"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.ghdl;
    }
    if ( current_value_80 === "cvc"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.cvc;
    }
            
    // tools -> cocotb -> compile_args
    const current_value_81 = json_config['tools']['cocotb']['compile_args'];
    if (typeof current_value_81 === 'string'){
        default_config['tools']['cocotb']['compile_args'] = current_value_81;
    }
            
    // tools -> cocotb -> run_args
    const current_value_82 = json_config['tools']['cocotb']['run_args'];
    if (typeof current_value_82 === 'string'){
        default_config['tools']['cocotb']['run_args'] = current_value_82;
    }
            
    // tools -> cocotb -> plusargs
    const current_value_83 = json_config['tools']['cocotb']['plusargs'];
    if (typeof current_value_83 === 'string'){
        default_config['tools']['cocotb']['plusargs'] = current_value_83;
    }
            
    // tools -> diamond -> installation_path
    const current_value_84 = json_config['tools']['diamond']['installation_path'];
    if (typeof current_value_84 === 'string'){
        default_config['tools']['diamond']['installation_path'] = current_value_84;
    }
            
    // tools -> diamond -> part
    const current_value_85 = json_config['tools']['diamond']['part'];
    if (typeof current_value_85 === 'string'){
        default_config['tools']['diamond']['part'] = current_value_85;
    }
            
    // tools -> ghdl -> installation_path
    const current_value_86 = json_config['tools']['ghdl']['installation_path'];
    if (typeof current_value_86 === 'string'){
        default_config['tools']['ghdl']['installation_path'] = current_value_86;
    }
            
    // tools -> ghdl -> waveform
    const current_value_87 = json_config['tools']['ghdl']['waveform'];
    if ( current_value_87 === "vcd"){
        default_config['tools']['ghdl']['waveform'] = e_tools_ghdl_waveform.vcd;
    }
    if ( current_value_87 === "ghw"){
        default_config['tools']['ghdl']['waveform'] = e_tools_ghdl_waveform.ghw;
    }
            
    // tools -> ghdl -> analyze_options
    const current_value_88 = json_config['tools']['ghdl']['analyze_options'];
    if (Array.isArray(current_value_88)){
        default_config['tools']['ghdl']['analyze_options'] = current_value_88;
    }
            
    // tools -> ghdl -> run_options
    const current_value_89 = json_config['tools']['ghdl']['run_options'];
    if (Array.isArray(current_value_89)){
        default_config['tools']['ghdl']['run_options'] = current_value_89;
    }
            
    // tools -> icarus -> installation_path
    const current_value_90 = json_config['tools']['icarus']['installation_path'];
    if (typeof current_value_90 === 'string'){
        default_config['tools']['icarus']['installation_path'] = current_value_90;
    }
            
    // tools -> icarus -> timescale
    const current_value_91 = json_config['tools']['icarus']['timescale'];
    if (typeof current_value_91 === 'string'){
        default_config['tools']['icarus']['timescale'] = current_value_91;
    }
            
    // tools -> icarus -> iverilog_options
    const current_value_92 = json_config['tools']['icarus']['iverilog_options'];
    if (Array.isArray(current_value_92)){
        default_config['tools']['icarus']['iverilog_options'] = current_value_92;
    }
            
    // tools -> icestorm -> installation_path
    const current_value_93 = json_config['tools']['icestorm']['installation_path'];
    if (typeof current_value_93 === 'string'){
        default_config['tools']['icestorm']['installation_path'] = current_value_93;
    }
            
    // tools -> icestorm -> pnr
    const current_value_94 = json_config['tools']['icestorm']['pnr'];
    if ( current_value_94 === "arachne"){
        default_config['tools']['icestorm']['pnr'] = e_tools_icestorm_pnr.arachne;
    }
    if ( current_value_94 === "next"){
        default_config['tools']['icestorm']['pnr'] = e_tools_icestorm_pnr.next;
    }
    if ( current_value_94 === "none"){
        default_config['tools']['icestorm']['pnr'] = e_tools_icestorm_pnr.none;
    }
            
    // tools -> icestorm -> arch
    const current_value_95 = json_config['tools']['icestorm']['arch'];
    if ( current_value_95 === "xilinx"){
        default_config['tools']['icestorm']['arch'] = e_tools_icestorm_arch.xilinx;
    }
    if ( current_value_95 === "ice40"){
        default_config['tools']['icestorm']['arch'] = e_tools_icestorm_arch.ice40;
    }
    if ( current_value_95 === "ecp5"){
        default_config['tools']['icestorm']['arch'] = e_tools_icestorm_arch.ecp5;
    }
            
    // tools -> icestorm -> output_format
    const current_value_96 = json_config['tools']['icestorm']['output_format'];
    if ( current_value_96 === "json"){
        default_config['tools']['icestorm']['output_format'] = e_tools_icestorm_output_format.json;
    }
    if ( current_value_96 === "edif"){
        default_config['tools']['icestorm']['output_format'] = e_tools_icestorm_output_format.edif;
    }
    if ( current_value_96 === "blif"){
        default_config['tools']['icestorm']['output_format'] = e_tools_icestorm_output_format.blif;
    }
            
    // tools -> icestorm -> yosys_as_subtool
    const current_value_97 = json_config['tools']['icestorm']['yosys_as_subtool'];
    if (current_value_97 === true || current_value_97 === false){
        default_config['tools']['icestorm']['yosys_as_subtool'] = current_value_97;
    }
            
    // tools -> icestorm -> makefile_name
    const current_value_98 = json_config['tools']['icestorm']['makefile_name'];
    if (typeof current_value_98 === 'string'){
        default_config['tools']['icestorm']['makefile_name'] = current_value_98;
    }
            
    // tools -> icestorm -> arachne_pnr_options
    const current_value_99 = json_config['tools']['icestorm']['arachne_pnr_options'];
    if (Array.isArray(current_value_99)){
        default_config['tools']['icestorm']['arachne_pnr_options'] = current_value_99;
    }
            
    // tools -> icestorm -> nextpnr_options
    const current_value_100 = json_config['tools']['icestorm']['nextpnr_options'];
    if (Array.isArray(current_value_100)){
        default_config['tools']['icestorm']['nextpnr_options'] = current_value_100;
    }
            
    // tools -> icestorm -> yosys_synth_options
    const current_value_101 = json_config['tools']['icestorm']['yosys_synth_options'];
    if (Array.isArray(current_value_101)){
        default_config['tools']['icestorm']['yosys_synth_options'] = current_value_101;
    }
            
    // tools -> ise -> installation_path
    const current_value_102 = json_config['tools']['ise']['installation_path'];
    if (typeof current_value_102 === 'string'){
        default_config['tools']['ise']['installation_path'] = current_value_102;
    }
            
    // tools -> ise -> family
    const current_value_103 = json_config['tools']['ise']['family'];
    if (typeof current_value_103 === 'string'){
        default_config['tools']['ise']['family'] = current_value_103;
    }
            
    // tools -> ise -> device
    const current_value_104 = json_config['tools']['ise']['device'];
    if (typeof current_value_104 === 'string'){
        default_config['tools']['ise']['device'] = current_value_104;
    }
            
    // tools -> ise -> package
    const current_value_105 = json_config['tools']['ise']['package'];
    if (typeof current_value_105 === 'string'){
        default_config['tools']['ise']['package'] = current_value_105;
    }
            
    // tools -> ise -> speed
    const current_value_106 = json_config['tools']['ise']['speed'];
    if (typeof current_value_106 === 'string'){
        default_config['tools']['ise']['speed'] = current_value_106;
    }
            
    // tools -> isem -> installation_path
    const current_value_107 = json_config['tools']['isem']['installation_path'];
    if (typeof current_value_107 === 'string'){
        default_config['tools']['isem']['installation_path'] = current_value_107;
    }
            
    // tools -> isem -> fuse_options
    const current_value_108 = json_config['tools']['isem']['fuse_options'];
    if (Array.isArray(current_value_108)){
        default_config['tools']['isem']['fuse_options'] = current_value_108;
    }
            
    // tools -> isem -> isim_options
    const current_value_109 = json_config['tools']['isem']['isim_options'];
    if (Array.isArray(current_value_109)){
        default_config['tools']['isem']['isim_options'] = current_value_109;
    }
            
    // tools -> modelsim -> installation_path
    const current_value_110 = json_config['tools']['modelsim']['installation_path'];
    if (typeof current_value_110 === 'string'){
        default_config['tools']['modelsim']['installation_path'] = current_value_110;
    }
            
    // tools -> modelsim -> vcom_options
    const current_value_111 = json_config['tools']['modelsim']['vcom_options'];
    if (Array.isArray(current_value_111)){
        default_config['tools']['modelsim']['vcom_options'] = current_value_111;
    }
            
    // tools -> modelsim -> vlog_options
    const current_value_112 = json_config['tools']['modelsim']['vlog_options'];
    if (Array.isArray(current_value_112)){
        default_config['tools']['modelsim']['vlog_options'] = current_value_112;
    }
            
    // tools -> modelsim -> vsim_options
    const current_value_113 = json_config['tools']['modelsim']['vsim_options'];
    if (Array.isArray(current_value_113)){
        default_config['tools']['modelsim']['vsim_options'] = current_value_113;
    }
            
    // tools -> morty -> installation_path
    const current_value_114 = json_config['tools']['morty']['installation_path'];
    if (typeof current_value_114 === 'string'){
        default_config['tools']['morty']['installation_path'] = current_value_114;
    }
            
    // tools -> morty -> morty_options
    const current_value_115 = json_config['tools']['morty']['morty_options'];
    if (Array.isArray(current_value_115)){
        default_config['tools']['morty']['morty_options'] = current_value_115;
    }
            
    // tools -> quartus -> installation_path
    const current_value_116 = json_config['tools']['quartus']['installation_path'];
    if (typeof current_value_116 === 'string'){
        default_config['tools']['quartus']['installation_path'] = current_value_116;
    }
            
    // tools -> quartus -> family
    const current_value_117 = json_config['tools']['quartus']['family'];
    if (typeof current_value_117 === 'string'){
        default_config['tools']['quartus']['family'] = current_value_117;
    }
            
    // tools -> quartus -> device
    const current_value_118 = json_config['tools']['quartus']['device'];
    if (typeof current_value_118 === 'string'){
        default_config['tools']['quartus']['device'] = current_value_118;
    }
            
    // tools -> quartus -> cable
    const current_value_119 = json_config['tools']['quartus']['cable'];
    if (typeof current_value_119 === 'string'){
        default_config['tools']['quartus']['cable'] = current_value_119;
    }
            
    // tools -> quartus -> board_device_index
    const current_value_120 = json_config['tools']['quartus']['board_device_index'];
    if (typeof current_value_120 === 'string'){
        default_config['tools']['quartus']['board_device_index'] = current_value_120;
    }
            
    // tools -> quartus -> pnr
    const current_value_121 = json_config['tools']['quartus']['pnr'];
    if ( current_value_121 === "default"){
        default_config['tools']['quartus']['pnr'] = e_tools_quartus_pnr.default;
    }
    if ( current_value_121 === "dse"){
        default_config['tools']['quartus']['pnr'] = e_tools_quartus_pnr.dse;
    }
    if ( current_value_121 === "none"){
        default_config['tools']['quartus']['pnr'] = e_tools_quartus_pnr.none;
    }
            
    // tools -> quartus -> dse_options
    const current_value_122 = json_config['tools']['quartus']['dse_options'];
    if (Array.isArray(current_value_122)){
        default_config['tools']['quartus']['dse_options'] = current_value_122;
    }
            
    // tools -> quartus -> quartus_options
    const current_value_123 = json_config['tools']['quartus']['quartus_options'];
    if (Array.isArray(current_value_123)){
        default_config['tools']['quartus']['quartus_options'] = current_value_123;
    }
            
    // tools -> radiant -> installation_path
    const current_value_124 = json_config['tools']['radiant']['installation_path'];
    if (typeof current_value_124 === 'string'){
        default_config['tools']['radiant']['installation_path'] = current_value_124;
    }
            
    // tools -> radiant -> part
    const current_value_125 = json_config['tools']['radiant']['part'];
    if (typeof current_value_125 === 'string'){
        default_config['tools']['radiant']['part'] = current_value_125;
    }
            
    // tools -> rivierapro -> installation_path
    const current_value_126 = json_config['tools']['rivierapro']['installation_path'];
    if (typeof current_value_126 === 'string'){
        default_config['tools']['rivierapro']['installation_path'] = current_value_126;
    }
            
    // tools -> rivierapro -> compilation_mode
    const current_value_127 = json_config['tools']['rivierapro']['compilation_mode'];
    if (typeof current_value_127 === 'string'){
        default_config['tools']['rivierapro']['compilation_mode'] = current_value_127;
    }
            
    // tools -> rivierapro -> vlog_options
    const current_value_128 = json_config['tools']['rivierapro']['vlog_options'];
    if (Array.isArray(current_value_128)){
        default_config['tools']['rivierapro']['vlog_options'] = current_value_128;
    }
            
    // tools -> rivierapro -> vsim_options
    const current_value_129 = json_config['tools']['rivierapro']['vsim_options'];
    if (Array.isArray(current_value_129)){
        default_config['tools']['rivierapro']['vsim_options'] = current_value_129;
    }
            
    // tools -> siliconcompiler -> installation_path
    const current_value_130 = json_config['tools']['siliconcompiler']['installation_path'];
    if (typeof current_value_130 === 'string'){
        default_config['tools']['siliconcompiler']['installation_path'] = current_value_130;
    }
            
    // tools -> siliconcompiler -> target
    const current_value_131 = json_config['tools']['siliconcompiler']['target'];
    if (typeof current_value_131 === 'string'){
        default_config['tools']['siliconcompiler']['target'] = current_value_131;
    }
            
    // tools -> siliconcompiler -> server_enable
    const current_value_132 = json_config['tools']['siliconcompiler']['server_enable'];
    if (current_value_132 === true || current_value_132 === false){
        default_config['tools']['siliconcompiler']['server_enable'] = current_value_132;
    }
            
    // tools -> siliconcompiler -> server_address
    const current_value_133 = json_config['tools']['siliconcompiler']['server_address'];
    if (typeof current_value_133 === 'string'){
        default_config['tools']['siliconcompiler']['server_address'] = current_value_133;
    }
            
    // tools -> siliconcompiler -> server_username
    const current_value_134 = json_config['tools']['siliconcompiler']['server_username'];
    if (typeof current_value_134 === 'string'){
        default_config['tools']['siliconcompiler']['server_username'] = current_value_134;
    }
            
    // tools -> siliconcompiler -> server_password
    const current_value_135 = json_config['tools']['siliconcompiler']['server_password'];
    if (typeof current_value_135 === 'string'){
        default_config['tools']['siliconcompiler']['server_password'] = current_value_135;
    }
    ...
    if ( current_value_200 === "xilinx"){
        default_config['tools']['openfpga']['arch'] = e_tools_openfpga_arch.xilinx;
    }
    if ( current_value_200 === "ice40"){
        default_config['tools']['openfpga']['arch'] = e_tools_openfpga_arch.ice40;
    }
    if ( current_value_200 === "ecp5"){
        default_config['tools']['openfpga']['arch'] = e_tools_openfpga_arch.ecp5;
    }
            
    // tools -> openfpga -> output_format
    const current_value_201 = json_config['tools']['openfpga']['output_format'];
    if ( current_value_201 === "json"){
        default_config['tools']['openfpga']['output_format'] = e_tools_openfpga_output_format.json;
    }
    if ( current_value_201 === "edif"){
        default_config['tools']['openfpga']['output_format'] = e_tools_openfpga_output_format.edif;
    }
    if ( current_value_201 === "blif"){
        default_config['tools']['openfpga']['output_format'] = e_tools_openfpga_output_format.blif;
    }
            
    // tools -> openfpga -> yosys_as_subtool
    const current_value_202 = json_config['tools']['openfpga']['yosys_as_subtool'];
    if (current_value_202 === true || current_value_202 === false){
        default_config['tools']['openfpga']['yosys_as_subtool'] = current_value_202;
    }
            
    // tools -> openfpga -> makefile_name
    const current_value_203 = json_config['tools']['openfpga']['makefile_name'];
    if (typeof current_value_203 === 'string'){
        default_config['tools']['openfpga']['makefile_name'] = current_value_203;
    }
            
    // tools -> openfpga -> script_name
    const current_value_204 = json_config['tools']['openfpga']['script_name'];
    if (typeof current_value_204 === 'string'){
        default_config['tools']['openfpga']['script_name'] = current_value_204;
    }
            
    // tools -> openfpga -> yosys_synth_options
    const current_value_205 = json_config['tools']['openfpga']['yosys_synth_options'];
    if (Array.isArray(current_value_205)){
        default_config['tools']['openfpga']['yosys_synth_options'] = current_value_205;
    }
            
    // tools -> activehdl -> installation_path
    const current_value_206 = json_config['tools']['activehdl']['installation_path'];
    if (typeof current_value_206 === 'string'){
        default_config['tools']['activehdl']['installation_path'] = current_value_206;
    }
            
    // tools -> nvc -> installation_path
    const current_value_207 = json_config['tools']['nvc']['installation_path'];
    if (typeof current_value_207 === 'string'){
        default_config['tools']['nvc']['installation_path'] = current_value_207;
    }
            
    // tools -> questa -> installation_path
    const current_value_208 = json_config['tools']['questa']['installation_path'];
    ...
    const current_value_209 = json_config['tools']['raptor']['installation_path'];
    ...
    const current_value_210 = json_config['tools']['raptor']['target_device'];
    if (typeof current_value_210 === 'string'){
        default_config['tools']['raptor']['target_device'] = current_value_210;
    }
            
    // tools -> raptor -> vhdl_version
    const current_value_211 = json_config['tools']['raptor']['vhdl_version'];
    ...
    const current_value_212 = json_config['tools']['raptor']['verilog_version'];
    ...
    const current_value_213 = json_config['tools']['raptor']['sv_version'];
    ...
    const current_value_215 = json_config['tools']['raptor']['optimization'];
    ...
    // tools -> raptor -> effort
    const current_value_216 = json_config['tools']['raptor']['effort'];
    ...
    const current_value_217 = json_config['tools']['raptor']['fsm_encoding'];
    ...
    // tools -> raptor -> carry
    const current_value_218 = json_config['tools']['raptor']['carry'];
    ...
    const current_value_219 = json_config['tools']['raptor']['pnr_netlist_language'];
    ...
    const current_value_220 = json_config['tools']['raptor']['dsp_limit'];
    if (typeof current_value_220 === 'number'){
        default_config['tools']['raptor']['dsp_limit'] = current_value_220;
    }
            
    // tools -> raptor -> block_ram_limit
    const current_value_221 = json_config['tools']['raptor']['block_ram_limit'];
    ...
    const current_value_222 = json_config['tools']['raptor']['fast_synthesis'];
    ...
    const current_value_227 = json_config['tools']['raptor']['waveform_rtl'];
    if (typeof current_value_227 === 'string'){
        default_config['tools']['raptor']['waveform_rtl'] = current_value_227;
    }
            
    // tools -> raptor -> simulator_rtl
    const current_value_228 = json_config['tools']['raptor']['simulator_rtl'];
    ...
    const current_value_229 = json_config['tools']['raptor']['simulation_options_rtl'];
    ...
    const current_value_230 = json_config['tools']['raptor']['simulate_gate'];
    ...
    const current_value_231 = json_config['tools']['raptor']['waveform_gate'];
    if (typeof current_value_231 === 'string'){
        default_config['tools']['raptor']['waveform_gate'] = current_value_231;
    }
            
    // tools -> raptor -> simulator_gate
    const current_value_232 = json_config['tools']['raptor']['simulator_gate'];
    ...
    const current_value_233 = json_config['tools']['raptor']['simulation_options_gate'];
    ...
    const current_value_234 = json_config['tools']['raptor']['simulate_pnr'];
    ...
    const current_value_235 = json_config['tools']['raptor']['waveform_pnr'];
    if (typeof current_value_235 === 'string'){
        default_config['tools']['raptor']['waveform_pnr'] = current_value_235;
    }
            
    // tools -> raptor -> simulator_pnr
    const current_value_236 = json_config['tools']['raptor']['simulator_pnr'];
    ...
    const current_value_237 = json_config['tools']['raptor']['simulation_options_pnr'];
