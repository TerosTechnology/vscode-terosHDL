...
export function get_config_from_json(json_config: any): e_config {
    ...
    // linter -> vsg -> configuration
    const current_value_61 = json_config['linter']['vsg']['configuration'];
    if (typeof current_value_61 === 'string'){
        default_config['linter']['vsg']['configuration'] = current_value_61;
    }
    ...
    if ( current_value_77 === "cvc"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.cvc;
    }
            
    // tools -> cocotb -> compile_args
    const current_value_78 = json_config['tools']['cocotb']['compile_args'];
    if (typeof current_value_78 === 'string'){
        default_config['tools']['cocotb']['compile_args'] = current_value_78;
    }
            
    // tools -> cocotb -> run_args
    const current_value_79 = json_config['tools']['cocotb']['run_args'];
    if (typeof current_value_79 === 'string'){
        default_config['tools']['cocotb']['run_args'] = current_value_79;
    }
            
    // tools -> cocotb -> plusargs
    const current_value_80 = json_config['tools']['cocotb']['plusargs'];
    if (typeof current_value_80 === 'string'){
        default_config['tools']['cocotb']['plusargs'] = current_value_80;
    }
            
    // tools -> diamond -> installation_path
    const current_value_81 = json_config['tools']['diamond']['installation_path'];
    if (typeof current_value_81 === 'string'){
        default_config['tools']['diamond']['installation_path'] = current_value_81;
    }
            
    // tools -> diamond -> part
    const current_value_82 = json_config['tools']['diamond']['part'];
    if (typeof current_value_82 === 'string'){
        default_config['tools']['diamond']['part'] = current_value_82;
    }
            
    // tools -> ghdl -> installation_path
    const current_value_83 = json_config['tools']['ghdl']['installation_path'];
    if (typeof current_value_83 === 'string'){
        default_config['tools']['ghdl']['installation_path'] = current_value_83;
    }
            
    // tools -> ghdl -> waveform
    const current_value_84 = json_config['tools']['ghdl']['waveform'];
    if ( current_value_84 === "vcd"){
        default_config['tools']['ghdl']['waveform'] = e_tools_ghdl_waveform.vcd;
    }
    if ( current_value_84 === "ghw"){
        default_config['tools']['ghdl']['waveform'] = e_tools_ghdl_waveform.ghw;
    }
            
    // tools -> ghdl -> analyze_options
    const current_value_85 = json_config['tools']['ghdl']['analyze_options'];
    if (Array.isArray(current_value_85)){
        default_config['tools']['ghdl']['analyze_options'] = current_value_85;
    }
            
    // tools -> ghdl -> run_options
    const current_value_86 = json_config['tools']['ghdl']['run_options'];
    if (Array.isArray(current_value_86)){
        default_config['tools']['ghdl']['run_options'] = current_value_86;
    }
            
    // tools -> icarus -> installation_path
    const current_value_87 = json_config['tools']['icarus']['installation_path'];
    if (typeof current_value_87 === 'string'){
        default_config['tools']['icarus']['installation_path'] = current_value_87;
    }
            
    // tools -> icarus -> timescale
    const current_value_88 = json_config['tools']['icarus']['timescale'];
    if (typeof current_value_88 === 'string'){
        default_config['tools']['icarus']['timescale'] = current_value_88;
    }
            
    // tools -> icarus -> iverilog_options
    const current_value_89 = json_config['tools']['icarus']['iverilog_options'];
    if (Array.isArray(current_value_89)){
        default_config['tools']['icarus']['iverilog_options'] = current_value_89;
    }
            
    // tools -> icestorm -> installation_path
    const current_value_90 = json_config['tools']['icestorm']['installation_path'];
    if (typeof current_value_90 === 'string'){
        default_config['tools']['icestorm']['installation_path'] = current_value_90;
    }
            
    // tools -> icestorm -> pnr
    const current_value_91 = json_config['tools']['icestorm']['pnr'];
    if ( current_value_91 === "arachne"){
        default_config['tools']['icestorm']['pnr'] = e_tools_icestorm_pnr.arachne;
    }
    if ( current_value_91 === "next"){
        default_config['tools']['icestorm']['pnr'] = e_tools_icestorm_pnr.next;
    }
    if ( current_value_91 === "none"){
        default_config['tools']['icestorm']['pnr'] = e_tools_icestorm_pnr.none;
    }
            
    // tools -> icestorm -> arch
    const current_value_92 = json_config['tools']['icestorm']['arch'];
    if ( current_value_92 === "xilinx"){
        default_config['tools']['icestorm']['arch'] = e_tools_icestorm_arch.xilinx;
    }
    if ( current_value_92 === "ice40"){
        default_config['tools']['icestorm']['arch'] = e_tools_icestorm_arch.ice40;
    }
    if ( current_value_92 === "ecp5"){
        default_config['tools']['icestorm']['arch'] = e_tools_icestorm_arch.ecp5;
    }
            
    // tools -> icestorm -> output_format
    const current_value_93 = json_config['tools']['icestorm']['output_format'];
    if ( current_value_93 === "json"){
        default_config['tools']['icestorm']['output_format'] = e_tools_icestorm_output_format.json;
    }
    if ( current_value_93 === "edif"){
        default_config['tools']['icestorm']['output_format'] = e_tools_icestorm_output_format.edif;
    }
    if ( current_value_93 === "blif"){
        default_config['tools']['icestorm']['output_format'] = e_tools_icestorm_output_format.blif;
    }
            
    // tools -> icestorm -> yosys_as_subtool
    const current_value_94 = json_config['tools']['icestorm']['yosys_as_subtool'];
    if (current_value_94 === true || current_value_94 === false){
        default_config['tools']['icestorm']['yosys_as_subtool'] = current_value_94;
    }
            
    // tools -> icestorm -> makefile_name
    const current_value_95 = json_config['tools']['icestorm']['makefile_name'];
    if (typeof current_value_95 === 'string'){
        default_config['tools']['icestorm']['makefile_name'] = current_value_95;
    }
            
    // tools -> icestorm -> arachne_pnr_options
    const current_value_96 = json_config['tools']['icestorm']['arachne_pnr_options'];
    if (Array.isArray(current_value_96)){
        default_config['tools']['icestorm']['arachne_pnr_options'] = current_value_96;
    }
            
    // tools -> icestorm -> nextpnr_options
    const current_value_97 = json_config['tools']['icestorm']['nextpnr_options'];
    if (Array.isArray(current_value_97)){
        default_config['tools']['icestorm']['nextpnr_options'] = current_value_97;
    }
            
    // tools -> icestorm -> yosys_synth_options
    const current_value_98 = json_config['tools']['icestorm']['yosys_synth_options'];
    if (Array.isArray(current_value_98)){
        default_config['tools']['icestorm']['yosys_synth_options'] = current_value_98;
    }
            
    // tools -> ise -> installation_path
    const current_value_99 = json_config['tools']['ise']['installation_path'];
    if (typeof current_value_99 === 'string'){
        default_config['tools']['ise']['installation_path'] = current_value_99;
    }
            
    // tools -> ise -> family
    const current_value_100 = json_config['tools']['ise']['family'];
    if (typeof current_value_100 === 'string'){
        default_config['tools']['ise']['family'] = current_value_100;
    }
            
    // tools -> ise -> device
    const current_value_101 = json_config['tools']['ise']['device'];
    if (typeof current_value_101 === 'string'){
        default_config['tools']['ise']['device'] = current_value_101;
    }
            
    // tools -> ise -> package
    const current_value_102 = json_config['tools']['ise']['package'];
    if (typeof current_value_102 === 'string'){
        default_config['tools']['ise']['package'] = current_value_102;
    }
            
    // tools -> ise -> speed
    const current_value_103 = json_config['tools']['ise']['speed'];
    if (typeof current_value_103 === 'string'){
        default_config['tools']['ise']['speed'] = current_value_103;
    }
            
    // tools -> isem -> installation_path
    const current_value_104 = json_config['tools']['isem']['installation_path'];
    if (typeof current_value_104 === 'string'){
        default_config['tools']['isem']['installation_path'] = current_value_104;
    }
            
    // tools -> isem -> fuse_options
    const current_value_105 = json_config['tools']['isem']['fuse_options'];
    if (Array.isArray(current_value_105)){
        default_config['tools']['isem']['fuse_options'] = current_value_105;
    }
            
    // tools -> isem -> isim_options
    const current_value_106 = json_config['tools']['isem']['isim_options'];
    if (Array.isArray(current_value_106)){
        default_config['tools']['isem']['isim_options'] = current_value_106;
    }
            
    // tools -> modelsim -> installation_path
    const current_value_107 = json_config['tools']['modelsim']['installation_path'];
    if (typeof current_value_107 === 'string'){
        default_config['tools']['modelsim']['installation_path'] = current_value_107;
    }
            
    // tools -> modelsim -> vcom_options
    const current_value_108 = json_config['tools']['modelsim']['vcom_options'];
    if (Array.isArray(current_value_108)){
        default_config['tools']['modelsim']['vcom_options'] = current_value_108;
    }
            
    // tools -> modelsim -> vlog_options
    const current_value_109 = json_config['tools']['modelsim']['vlog_options'];
    if (Array.isArray(current_value_109)){
        default_config['tools']['modelsim']['vlog_options'] = current_value_109;
    }
            
    // tools -> modelsim -> vsim_options
    const current_value_110 = json_config['tools']['modelsim']['vsim_options'];
    if (Array.isArray(current_value_110)){
        default_config['tools']['modelsim']['vsim_options'] = current_value_110;
    }
            
    // tools -> morty -> installation_path
    const current_value_111 = json_config['tools']['morty']['installation_path'];
    if (typeof current_value_111 === 'string'){
        default_config['tools']['morty']['installation_path'] = current_value_111;
    }
            
    // tools -> morty -> morty_options
    const current_value_112 = json_config['tools']['morty']['morty_options'];
    if (Array.isArray(current_value_112)){
        default_config['tools']['morty']['morty_options'] = current_value_112;
    }
            
    // tools -> quartus -> installation_path
    const current_value_113 = json_config['tools']['quartus']['installation_path'];
    if (typeof current_value_113 === 'string'){
        default_config['tools']['quartus']['installation_path'] = current_value_113;
    }
            
    // tools -> quartus -> family
    const current_value_114 = json_config['tools']['quartus']['family'];
    if (typeof current_value_114 === 'string'){
        default_config['tools']['quartus']['family'] = current_value_114;
    }
            
    // tools -> quartus -> device
    const current_value_115 = json_config['tools']['quartus']['device'];
    if (typeof current_value_115 === 'string'){
        default_config['tools']['quartus']['device'] = current_value_115;
    }
            
    // tools -> quartus -> cable
    const current_value_116 = json_config['tools']['quartus']['cable'];
    if (typeof current_value_116 === 'string'){
        default_config['tools']['quartus']['cable'] = current_value_116;
    }
            
    // tools -> quartus -> board_device_index
    const current_value_117 = json_config['tools']['quartus']['board_device_index'];
    if (typeof current_value_117 === 'string'){
        default_config['tools']['quartus']['board_device_index'] = current_value_117;
    }
            
    // tools -> quartus -> pnr
    const current_value_118 = json_config['tools']['quartus']['pnr'];
    if ( current_value_118 === "default"){
        default_config['tools']['quartus']['pnr'] = e_tools_quartus_pnr.default;
    }
    if ( current_value_118 === "dse"){
        default_config['tools']['quartus']['pnr'] = e_tools_quartus_pnr.dse;
    }
    if ( current_value_118 === "none"){
        default_config['tools']['quartus']['pnr'] = e_tools_quartus_pnr.none;
    }
            
    // tools -> quartus -> dse_options
    const current_value_119 = json_config['tools']['quartus']['dse_options'];
    if (Array.isArray(current_value_119)){
        default_config['tools']['quartus']['dse_options'] = current_value_119;
    }
            
    // tools -> quartus -> quartus_options
    const current_value_120 = json_config['tools']['quartus']['quartus_options'];
    if (Array.isArray(current_value_120)){
        default_config['tools']['quartus']['quartus_options'] = current_value_120;
    }
            
    // tools -> radiant -> installation_path
    const current_value_121 = json_config['tools']['radiant']['installation_path'];
    if (typeof current_value_121 === 'string'){
        default_config['tools']['radiant']['installation_path'] = current_value_121;
    }
            
    // tools -> radiant -> part
    const current_value_122 = json_config['tools']['radiant']['part'];
    if (typeof current_value_122 === 'string'){
        default_config['tools']['radiant']['part'] = current_value_122;
    }
            
    // tools -> rivierapro -> installation_path
    const current_value_123 = json_config['tools']['rivierapro']['installation_path'];
    if (typeof current_value_123 === 'string'){
        default_config['tools']['rivierapro']['installation_path'] = current_value_123;
    }
            
    // tools -> rivierapro -> compilation_mode
    const current_value_124 = json_config['tools']['rivierapro']['compilation_mode'];
    if (typeof current_value_124 === 'string'){
        default_config['tools']['rivierapro']['compilation_mode'] = current_value_124;
    }
            
    // tools -> rivierapro -> vlog_options
    const current_value_125 = json_config['tools']['rivierapro']['vlog_options'];
    if (Array.isArray(current_value_125)){
        default_config['tools']['rivierapro']['vlog_options'] = current_value_125;
    }
            
    // tools -> rivierapro -> vsim_options
    const current_value_126 = json_config['tools']['rivierapro']['vsim_options'];
    if (Array.isArray(current_value_126)){
        default_config['tools']['rivierapro']['vsim_options'] = current_value_126;
    }
            
    // tools -> siliconcompiler -> installation_path
    const current_value_127 = json_config['tools']['siliconcompiler']['installation_path'];
    if (typeof current_value_127 === 'string'){
        default_config['tools']['siliconcompiler']['installation_path'] = current_value_127;
    }
            
    // tools -> siliconcompiler -> target
    const current_value_128 = json_config['tools']['siliconcompiler']['target'];
    if (typeof current_value_128 === 'string'){
        default_config['tools']['siliconcompiler']['target'] = current_value_128;
    }
            
    // tools -> siliconcompiler -> server_enable
    const current_value_129 = json_config['tools']['siliconcompiler']['server_enable'];
    if (current_value_129 === true || current_value_129 === false){
        default_config['tools']['siliconcompiler']['server_enable'] = current_value_129;
    }
            
    // tools -> siliconcompiler -> server_address
    const current_value_130 = json_config['tools']['siliconcompiler']['server_address'];
    if (typeof current_value_130 === 'string'){
        default_config['tools']['siliconcompiler']['server_address'] = current_value_130;
    }
            
    // tools -> siliconcompiler -> server_username
    const current_value_131 = json_config['tools']['siliconcompiler']['server_username'];
    if (typeof current_value_131 === 'string'){
        default_config['tools']['siliconcompiler']['server_username'] = current_value_131;
    }
            
    // tools -> siliconcompiler -> server_password
    const current_value_132 = json_config['tools']['siliconcompiler']['server_password'];
    if (typeof current_value_132 === 'string'){
        default_config['tools']['siliconcompiler']['server_password'] = current_value_132;
    }
            
    // tools -> spyglass -> installation_path
    const current_value_133 = json_config['tools']['spyglass']['installation_path'];
    if (typeof current_value_133 === 'string'){
        default_config['tools']['spyglass']['installation_path'] = current_value_133;
    }
            
    // tools -> spyglass -> methodology
    const current_value_134 = json_config['tools']['spyglass']['methodology'];
    if (typeof current_value_134 === 'string'){
        default_config['tools']['spyglass']['methodology'] = current_value_134;
    }
            
    // tools -> spyglass -> goals
    const current_value_135 = json_config['tools']['spyglass']['goals'];
    if (Array.isArray(current_value_135)){
        default_config['tools']['spyglass']['goals'] = current_value_135;
    }
            
    // tools -> spyglass -> spyglass_options
    const current_value_136 = json_config['tools']['spyglass']['spyglass_options'];
    if (Array.isArray(current_value_136)){
        default_config['tools']['spyglass']['spyglass_options'] = current_value_136;
    }
            
    // tools -> spyglass -> rule_parameters
    const current_value_137 = json_config['tools']['spyglass']['rule_parameters'];
    if (Array.isArray(current_value_137)){
        default_config['tools']['spyglass']['rule_parameters'] = current_value_137;
    }
            
    // tools -> symbiyosys -> installation_path
    const current_value_138 = json_config['tools']['symbiyosys']['installation_path'];
    if (typeof current_value_138 === 'string'){
        default_config['tools']['symbiyosys']['installation_path'] = current_value_138;
    }
            
    // tools -> symbiyosys -> tasknames
    const current_value_139 = json_config['tools']['symbiyosys']['tasknames'];
    if (Array.isArray(current_value_139)){
        default_config['tools']['symbiyosys']['tasknames'] = current_value_139;
    }
            
    // tools -> symbiflow -> installation_path
    const current_value_140 = json_config['tools']['symbiflow']['installation_path'];
    if (typeof current_value_140 === 'string'){
        default_config['tools']['symbiflow']['installation_path'] = current_value_140;
    }
            
    // tools -> symbiflow -> package
    const current_value_141 = json_config['tools']['symbiflow']['package'];
    if (typeof current_value_141 === 'string'){
        default_config['tools']['symbiflow']['package'] = current_value_141;
    }
            
    // tools -> symbiflow -> part
    const current_value_142 = json_config['tools']['symbiflow']['part'];
    if (typeof current_value_142 === 'string'){
        default_config['tools']['symbiflow']['part'] = current_value_142;
    }
            
    // tools -> symbiflow -> vendor
    const current_value_143 = json_config['tools']['symbiflow']['vendor'];
    if (typeof current_value_143 === 'string'){
        default_config['tools']['symbiflow']['vendor'] = current_value_143;
    }
            
    // tools -> symbiflow -> pnr
    const current_value_144 = json_config['tools']['symbiflow']['pnr'];
    if ( current_value_144 === "vpr"){
        default_config['tools']['symbiflow']['pnr'] = e_tools_symbiflow_pnr.vpr;
    }
            
    // tools -> symbiflow -> vpr_options
    const current_value_145 = json_config['tools']['symbiflow']['vpr_options'];
    if (typeof current_value_145 === 'string'){
        default_config['tools']['symbiflow']['vpr_options'] = current_value_145;
    }
            
    // tools -> symbiflow -> environment_script
    const current_value_146 = json_config['tools']['symbiflow']['environment_script'];
    if (typeof current_value_146 === 'string'){
        default_config['tools']['symbiflow']['environment_script'] = current_value_146;
    }
            
    // tools -> trellis -> installation_path
    const current_value_147 = json_config['tools']['trellis']['installation_path'];
    if (typeof current_value_147 === 'string'){
        default_config['tools']['trellis']['installation_path'] = current_value_147;
    }
            
    // tools -> trellis -> arch
    const current_value_148 = json_config['tools']['trellis']['arch'];
    if ( current_value_148 === "xilinx"){
        default_config['tools']['trellis']['arch'] = e_tools_trellis_arch.xilinx;
    }
    if ( current_value_148 === "ice40"){
        default_config['tools']['trellis']['arch'] = e_tools_trellis_arch.ice40;
    }
    if ( current_value_148 === "ecp5"){
        default_config['tools']['trellis']['arch'] = e_tools_trellis_arch.ecp5;
    }
            
    // tools -> trellis -> output_format
    const current_value_149 = json_config['tools']['trellis']['output_format'];
    if ( current_value_149 === "json"){
        default_config['tools']['trellis']['output_format'] = e_tools_trellis_output_format.json;
    }
    if ( current_value_149 === "edif"){
        default_config['tools']['trellis']['output_format'] = e_tools_trellis_output_format.edif;
    }
    if ( current_value_149 === "blif"){
        default_config['tools']['trellis']['output_format'] = e_tools_trellis_output_format.blif;
    }
            
    // tools -> trellis -> yosys_as_subtool
    const current_value_150 = json_config['tools']['trellis']['yosys_as_subtool'];
    if (current_value_150 === true || current_value_150 === false){
        default_config['tools']['trellis']['yosys_as_subtool'] = current_value_150;
    }
            
    // tools -> trellis -> makefile_name
    const current_value_151 = json_config['tools']['trellis']['makefile_name'];
    if (typeof current_value_151 === 'string'){
        default_config['tools']['trellis']['makefile_name'] = current_value_151;
    }
            
    // tools -> trellis -> script_name
    const current_value_152 = json_config['tools']['trellis']['script_name'];
    if (typeof current_value_152 === 'string'){
        default_config['tools']['trellis']['script_name'] = current_value_152;
    }
            
    // tools -> trellis -> nextpnr_options
    const current_value_153 = json_config['tools']['trellis']['nextpnr_options'];
    if (Array.isArray(current_value_153)){
        default_config['tools']['trellis']['nextpnr_options'] = current_value_153;
    }
            
    // tools -> trellis -> yosys_synth_options
    const current_value_154 = json_config['tools']['trellis']['yosys_synth_options'];
    if (Array.isArray(current_value_154)){
        default_config['tools']['trellis']['yosys_synth_options'] = current_value_154;
    }
            
    // tools -> vcs -> installation_path
    const current_value_155 = json_config['tools']['vcs']['installation_path'];
    if (typeof current_value_155 === 'string'){
        default_config['tools']['vcs']['installation_path'] = current_value_155;
    }
            
    // tools -> vcs -> vcs_options
    const current_value_156 = json_config['tools']['vcs']['vcs_options'];
    if (Array.isArray(current_value_156)){
        default_config['tools']['vcs']['vcs_options'] = current_value_156;
    }
            
    // tools -> vcs -> run_options
    const current_value_157 = json_config['tools']['vcs']['run_options'];
    if (Array.isArray(current_value_157)){
        default_config['tools']['vcs']['run_options'] = current_value_157;
    }
            
    // tools -> verible -> installation_path
    const current_value_158 = json_config['tools']['verible']['installation_path'];
    if (typeof current_value_158 === 'string'){
        default_config['tools']['verible']['installation_path'] = current_value_158;
    }
            
    // tools -> verilator -> installation_path
    const current_value_159 = json_config['tools']['verilator']['installation_path'];
    if (typeof current_value_159 === 'string'){
        default_config['tools']['verilator']['installation_path'] = current_value_159;
    }
            
    // tools -> verilator -> mode
    const current_value_160 = json_config['tools']['verilator']['mode'];
    if ( current_value_160 === "cc"){
        default_config['tools']['verilator']['mode'] = e_tools_verilator_mode.cc;
    }
    if ( current_value_160 === "sc"){
        default_config['tools']['verilator']['mode'] = e_tools_verilator_mode.sc;
    }
    if ( current_value_160 === "lint-only"){
        default_config['tools']['verilator']['mode'] = e_tools_verilator_mode.lint_only;
    }
            
    // tools -> verilator -> libs
    const current_value_161 = json_config['tools']['verilator']['libs'];
    if (Array.isArray(current_value_161)){
        default_config['tools']['verilator']['libs'] = current_value_161;
    }
            
    // tools -> verilator -> verilator_options
    const current_value_162 = json_config['tools']['verilator']['verilator_options'];
    if (Array.isArray(current_value_162)){
        default_config['tools']['verilator']['verilator_options'] = current_value_162;
    }
            
    // tools -> verilator -> make_options
    const current_value_163 = json_config['tools']['verilator']['make_options'];
    if (Array.isArray(current_value_163)){
        default_config['tools']['verilator']['make_options'] = current_value_163;
    }
            
    // tools -> verilator -> run_options
    const current_value_164 = json_config['tools']['verilator']['run_options'];
    if (Array.isArray(current_value_164)){
        default_config['tools']['verilator']['run_options'] = current_value_164;
    }
            
    // tools -> vivado -> installation_path
    const current_value_165 = json_config['tools']['vivado']['installation_path'];
    if (typeof current_value_165 === 'string'){
        default_config['tools']['vivado']['installation_path'] = current_value_165;
    }
            
    // tools -> vivado -> part
    const current_value_166 = json_config['tools']['vivado']['part'];
    if (typeof current_value_166 === 'string'){
        default_config['tools']['vivado']['part'] = current_value_166;
    }
            
    // tools -> vivado -> synth
    const current_value_167 = json_config['tools']['vivado']['synth'];
    if (typeof current_value_167 === 'string'){
        default_config['tools']['vivado']['synth'] = current_value_167;
    }
            
    // tools -> vivado -> pnr
    const current_value_168 = json_config['tools']['vivado']['pnr'];
    if ( current_value_168 === "vivado"){
        default_config['tools']['vivado']['pnr'] = e_tools_vivado_pnr.vivado;
    }
    if ( current_value_168 === "none"){
        default_config['tools']['vivado']['pnr'] = e_tools_vivado_pnr.none;
    }
            
    // tools -> vivado -> jtag_freq
    const current_value_169 = json_config['tools']['vivado']['jtag_freq'];
    if (typeof current_value_169 === 'number'){
        default_config['tools']['vivado']['jtag_freq'] = current_value_169;
    }
            
    // tools -> vivado -> hw_target
    const current_value_170 = json_config['tools']['vivado']['hw_target'];
    if (typeof current_value_170 === 'string'){
        default_config['tools']['vivado']['hw_target'] = current_value_170;
    }
            
    // tools -> vunit -> installation_path
    const current_value_171 = json_config['tools']['vunit']['installation_path'];
    if (typeof current_value_171 === 'string'){
        default_config['tools']['vunit']['installation_path'] = current_value_171;
    }
            
    // tools -> vunit -> simulator_name
    const current_value_172 = json_config['tools']['vunit']['simulator_name'];
    if ( current_value_172 === "rivierapro"){
        default_config['tools']['vunit']['simulator_name'] = e_tools_vunit_simulator_name.rivierapro;
    }
    if ( current_value_172 === "activehdl"){
        default_config['tools']['vunit']['simulator_name'] = e_tools_vunit_simulator_name.activehdl;
    }
    if ( current_value_172 === "ghdl"){
        default_config['tools']['vunit']['simulator_name'] = e_tools_vunit_simulator_name.ghdl;
    }
    if ( current_value_172 === "modelsim"){
        default_config['tools']['vunit']['simulator_name'] = e_tools_vunit_simulator_name.modelsim;
    }
    if ( current_value_172 === "xsim"){
        default_config['tools']['vunit']['simulator_name'] = e_tools_vunit_simulator_name.xsim;
    }
            
    // tools -> vunit -> runpy_mode
    const current_value_173 = json_config['tools']['vunit']['runpy_mode'];
    if ( current_value_173 === "standalone"){
        default_config['tools']['vunit']['runpy_mode'] = e_tools_vunit_runpy_mode.standalone;
    }
    if ( current_value_173 === "creation"){
        default_config['tools']['vunit']['runpy_mode'] = e_tools_vunit_runpy_mode.creation;
    }
            
    // tools -> vunit -> extra_options
    const current_value_174 = json_config['tools']['vunit']['extra_options'];
    if (Array.isArray(current_value_174)){
        default_config['tools']['vunit']['extra_options'] = current_value_174;
    }
            
    // tools -> vunit -> enable_array_util_lib
    const current_value_175 = json_config['tools']['vunit']['enable_array_util_lib'];
    if (current_value_175 === true || current_value_175 === false){
        default_config['tools']['vunit']['enable_array_util_lib'] = current_value_175;
    }
            
    // tools -> vunit -> enable_com_lib
    const current_value_176 = json_config['tools']['vunit']['enable_com_lib'];
    if (current_value_176 === true || current_value_176 === false){
        default_config['tools']['vunit']['enable_com_lib'] = current_value_176;
    }
            
    // tools -> vunit -> enable_json4vhdl_lib
    const current_value_177 = json_config['tools']['vunit']['enable_json4vhdl_lib'];
    if (current_value_177 === true || current_value_177 === false){
        default_config['tools']['vunit']['enable_json4vhdl_lib'] = current_value_177;
    }
            
    // tools -> vunit -> enable_osvvm_lib
    const current_value_178 = json_config['tools']['vunit']['enable_osvvm_lib'];
    if (current_value_178 === true || current_value_178 === false){
        default_config['tools']['vunit']['enable_osvvm_lib'] = current_value_178;
    }
            
    // tools -> vunit -> enable_random_lib
    const current_value_179 = json_config['tools']['vunit']['enable_random_lib'];
    if (current_value_179 === true || current_value_179 === false){
        default_config['tools']['vunit']['enable_random_lib'] = current_value_179;
    }
            
    // tools -> vunit -> enable_verification_components_lib
    const current_value_180 = json_config['tools']['vunit']['enable_verification_components_lib'];
    if (current_value_180 === true || current_value_180 === false){
        default_config['tools']['vunit']['enable_verification_components_lib'] = current_value_180;
    }
            
    // tools -> xcelium -> installation_path
    const current_value_181 = json_config['tools']['xcelium']['installation_path'];
    if (typeof current_value_181 === 'string'){
        default_config['tools']['xcelium']['installation_path'] = current_value_181;
    }
            
    // tools -> xcelium -> xmvhdl_options
    const current_value_182 = json_config['tools']['xcelium']['xmvhdl_options'];
    if (Array.isArray(current_value_182)){
        default_config['tools']['xcelium']['xmvhdl_options'] = current_value_182;
    }
            
    // tools -> xcelium -> xmvlog_options
    const current_value_183 = json_config['tools']['xcelium']['xmvlog_options'];
    if (Array.isArray(current_value_183)){
        default_config['tools']['xcelium']['xmvlog_options'] = current_value_183;
    }
            
    // tools -> xcelium -> xmsim_options
    const current_value_184 = json_config['tools']['xcelium']['xmsim_options'];
    if (Array.isArray(current_value_184)){
        default_config['tools']['xcelium']['xmsim_options'] = current_value_184;
    }
            
    // tools -> xcelium -> xrun_options
    const current_value_185 = json_config['tools']['xcelium']['xrun_options'];
    if (Array.isArray(current_value_185)){
        default_config['tools']['xcelium']['xrun_options'] = current_value_185;
    }
            
    // tools -> xsim -> installation_path
    const current_value_186 = json_config['tools']['xsim']['installation_path'];
    if (typeof current_value_186 === 'string'){
        default_config['tools']['xsim']['installation_path'] = current_value_186;
    }
            
    // tools -> xsim -> xelab_options
    const current_value_187 = json_config['tools']['xsim']['xelab_options'];
    if (Array.isArray(current_value_187)){
        default_config['tools']['xsim']['xelab_options'] = current_value_187;
    }
            
    // tools -> xsim -> xsim_options
    const current_value_188 = json_config['tools']['xsim']['xsim_options'];
    if (Array.isArray(current_value_188)){
        default_config['tools']['xsim']['xsim_options'] = current_value_188;
    }
            
    // tools -> yosys -> installation_path
    const current_value_189 = json_config['tools']['yosys']['installation_path'];
    if (typeof current_value_189 === 'string'){
        default_config['tools']['yosys']['installation_path'] = current_value_189;
    }
            
    // tools -> yosys -> arch
    const current_value_190 = json_config['tools']['yosys']['arch'];
    if ( current_value_190 === "xilinx"){
        default_config['tools']['yosys']['arch'] = e_tools_yosys_arch.xilinx;
    }
    if ( current_value_190 === "ice40"){
        default_config['tools']['yosys']['arch'] = e_tools_yosys_arch.ice40;
    }
    if ( current_value_190 === "ecp5"){
        default_config['tools']['yosys']['arch'] = e_tools_yosys_arch.ecp5;
    }
            
    // tools -> yosys -> output_format
    const current_value_191 = json_config['tools']['yosys']['output_format'];
    if ( current_value_191 === "json"){
        default_config['tools']['yosys']['output_format'] = e_tools_yosys_output_format.json;
    }
    if ( current_value_191 === "edif"){
        default_config['tools']['yosys']['output_format'] = e_tools_yosys_output_format.edif;
    }
    if ( current_value_191 === "blif"){
        default_config['tools']['yosys']['output_format'] = e_tools_yosys_output_format.blif;
    }
            
    // tools -> yosys -> yosys_as_subtool
    const current_value_192 = json_config['tools']['yosys']['yosys_as_subtool'];
    if (current_value_192 === true || current_value_192 === false){
        default_config['tools']['yosys']['yosys_as_subtool'] = current_value_192;
    }
            
    // tools -> yosys -> makefile_name
    const current_value_193 = json_config['tools']['yosys']['makefile_name'];
    if (typeof current_value_193 === 'string'){
        default_config['tools']['yosys']['makefile_name'] = current_value_193;
    }
            
    // tools -> yosys -> script_name
    const current_value_194 = json_config['tools']['yosys']['script_name'];
    if (typeof current_value_194 === 'string'){
        default_config['tools']['yosys']['script_name'] = current_value_194;
    }
            
    // tools -> yosys -> yosys_synth_options
    const current_value_195 = json_config['tools']['yosys']['yosys_synth_options'];
    if (Array.isArray(current_value_195)){
        default_config['tools']['yosys']['yosys_synth_options'] = current_value_195;
    }
            
    // tools -> openfpga -> installation_path
    const current_value_196 = json_config['tools']['openfpga']['installation_path'];
    if (typeof current_value_196 === 'string'){
        default_config['tools']['openfpga']['installation_path'] = current_value_196;
    }
            
    // tools -> openfpga -> arch
    const current_value_197 = json_config['tools']['openfpga']['arch'];
    if ( current_value_197 === "xilinx"){
        default_config['tools']['openfpga']['arch'] = e_tools_openfpga_arch.xilinx;
    }
    if ( current_value_197 === "ice40"){
        default_config['tools']['openfpga']['arch'] = e_tools_openfpga_arch.ice40;
    }
    if ( current_value_197 === "ecp5"){
        default_config['tools']['openfpga']['arch'] = e_tools_openfpga_arch.ecp5;
    }
            
    // tools -> openfpga -> output_format
    const current_value_198 = json_config['tools']['openfpga']['output_format'];
    if ( current_value_198 === "json"){
        default_config['tools']['openfpga']['output_format'] = e_tools_openfpga_output_format.json;
    }
    if ( current_value_198 === "edif"){
        default_config['tools']['openfpga']['output_format'] = e_tools_openfpga_output_format.edif;
    }
    if ( current_value_198 === "blif"){
        default_config['tools']['openfpga']['output_format'] = e_tools_openfpga_output_format.blif;
    }
            
    // tools -> openfpga -> yosys_as_subtool
    const current_value_199 = json_config['tools']['openfpga']['yosys_as_subtool'];
    if (current_value_199 === true || current_value_199 === false){
        default_config['tools']['openfpga']['yosys_as_subtool'] = current_value_199;
    }
            
    // tools -> openfpga -> makefile_name
    const current_value_200 = json_config['tools']['openfpga']['makefile_name'];
    if (typeof current_value_200 === 'string'){
        default_config['tools']['openfpga']['makefile_name'] = current_value_200;
    }
            
    // tools -> openfpga -> script_name
    const current_value_201 = json_config['tools']['openfpga']['script_name'];
    if (typeof current_value_201 === 'string'){
        default_config['tools']['openfpga']['script_name'] = current_value_201;
    }
            
    // tools -> openfpga -> yosys_synth_options
    const current_value_202 = json_config['tools']['openfpga']['yosys_synth_options'];
    if (Array.isArray(current_value_202)){
        default_config['tools']['openfpga']['yosys_synth_options'] = current_value_202;
    }
            
    // tools -> activehdl -> installation_path
    const current_value_203 = json_config['tools']['activehdl']['installation_path'];
    if (typeof current_value_203 === 'string'){
        default_config['tools']['activehdl']['installation_path'] = current_value_203;
    }
            
    // tools -> nvc -> installation_path
    const current_value_204 = json_config['tools']['nvc']['installation_path'];
    if (typeof current_value_204 === 'string'){
        default_config['tools']['nvc']['installation_path'] = current_value_204;
    }
            
    // tools -> questa -> installation_path
    const current_value_205 = json_config['tools']['questa']['installation_path'];
    if (typeof current_value_205 === 'string'){
        default_config['tools']['questa']['installation_path'] = current_value_205;
    }
            
    // tools -> raptor -> installation_path
    const current_value_206 = json_config['tools']['raptor']['installation_path'];
    if (typeof current_value_206 === 'string'){
        default_config['tools']['raptor']['installation_path'] = current_value_206;
    }
            
    // tools -> raptor -> target_device
    const current_value_207 = json_config['tools']['raptor']['target_device'];
    if (typeof current_value_207 === 'string'){
        default_config['tools']['raptor']['target_device'] = current_value_207;
    }
            
    // tools -> raptor -> vhdl_version
    const current_value_208 = json_config['tools']['raptor']['vhdl_version'];
    if ( current_value_208 === "VHDL_1987"){
        default_config['tools']['raptor']['vhdl_version'] = e_tools_raptor_vhdl_version.VHDL_1987;
    }
    if ( current_value_208 === "VHDL_1993"){
        default_config['tools']['raptor']['vhdl_version'] = e_tools_raptor_vhdl_version.VHDL_1993;
    }
    if ( current_value_208 === "VHDL_2000"){
        default_config['tools']['raptor']['vhdl_version'] = e_tools_raptor_vhdl_version.VHDL_2000;
    }
    if ( current_value_208 === "VHDL_2008"){
        default_config['tools']['raptor']['vhdl_version'] = e_tools_raptor_vhdl_version.VHDL_2008;
    }
    if ( current_value_208 === "VHDL_2019"){
        default_config['tools']['raptor']['vhdl_version'] = e_tools_raptor_vhdl_version.VHDL_2019;
    }
            
    // tools -> raptor -> verilog_version
    const current_value_209 = json_config['tools']['raptor']['verilog_version'];
    if ( current_value_209 === "V_1995"){
        default_config['tools']['raptor']['verilog_version'] = e_tools_raptor_verilog_version.V_1995;
    }
    if ( current_value_209 === "V_2001"){
        default_config['tools']['raptor']['verilog_version'] = e_tools_raptor_verilog_version.V_2001;
    }
            
    // tools -> raptor -> sv_version
    const current_value_210 = json_config['tools']['raptor']['sv_version'];
    if ( current_value_210 === "SV_2005"){
        default_config['tools']['raptor']['sv_version'] = e_tools_raptor_sv_version.SV_2005;
    }
    if ( current_value_210 === "SV_2009"){
        default_config['tools']['raptor']['sv_version'] = e_tools_raptor_sv_version.SV_2009;
    }
    if ( current_value_210 === "SV_2012"){
        default_config['tools']['raptor']['sv_version'] = e_tools_raptor_sv_version.SV_2012;
    }
    if ( current_value_210 === "SV_2017"){
    ...
    // tools -> raptor -> carry
    const current_value_215 = json_config['tools']['raptor']['carry'];
    if ( current_value_215 === "auto"){
        default_config['tools']['raptor']['carry'] = e_tools_raptor_carry.auto;
    }
    if ( current_value_215 === "all"){
    ...
    const current_value_216 = json_config['tools']['raptor']['pnr_netlist_language'];
    if ( current_value_216 === "blif"){
        default_config['tools']['raptor']['pnr_netlist_language'] = e_tools_raptor_pnr_netlist_language.blif;
    }
    if ( current_value_216 === "edif"){
        default_config['tools']['raptor']['pnr_netlist_language'] = e_tools_raptor_pnr_netlist_language.edif;
    }
    if ( current_value_216 === "verilog"){
        default_config['tools']['raptor']['pnr_netlist_language'] = e_tools_raptor_pnr_netlist_language.verilog;
    }
    if ( current_value_216 === "vhdl"){
        default_config['tools']['raptor']['pnr_netlist_language'] = e_tools_raptor_pnr_netlist_language.vhdl;
    }
            
    // tools -> raptor -> no_dsp_blocks
    const current_value_217 = json_config['tools']['raptor']['no_dsp_blocks'];
    if (current_value_217 === true || current_value_217 === false){
        default_config['tools']['raptor']['no_dsp_blocks'] = current_value_217;
    }
            
    // tools -> raptor -> no_block_ram
    const current_value_218 = json_config['tools']['raptor']['no_block_ram'];
    if (current_value_218 === true || current_value_218 === false){
        default_config['tools']['raptor']['no_block_ram'] = current_value_218;
    }
            
    // tools -> raptor -> fast_synthesis
    const current_value_219 = json_config['tools']['raptor']['fast_synthesis'];
    if (current_value_219 === true || current_value_219 === false){
        default_config['tools']['raptor']['fast_synthesis'] = current_value_219;
    }
            
    // tools -> raptor -> div_1
            
    // tools -> raptor -> top_level
    const current_value_221 = json_config['tools']['raptor']['top_level'];
    if (typeof current_value_221 === 'string'){
        default_config['tools']['raptor']['top_level'] = current_value_221;
    }
            
    // tools -> raptor -> simulate_rtl
    const current_value_222 = json_config['tools']['raptor']['simulate_rtl'];
    if (current_value_222 === true || current_value_222 === false){
        default_config['tools']['raptor']['simulate_rtl'] = current_value_222;
    }
            
    // tools -> raptor -> waveform_rtl
    const current_value_223 = json_config['tools']['raptor']['waveform_rtl'];
    if (typeof current_value_223 === 'string'){
        default_config['tools']['raptor']['waveform_rtl'] = current_value_223;
    }
            
    // tools -> raptor -> simulator_rtl
    const current_value_224 = json_config['tools']['raptor']['simulator_rtl'];
    ...
    const current_value_225 = json_config['tools']['raptor']['simulation_options_rtl'];
    if (typeof current_value_225 === 'string'){
        default_config['tools']['raptor']['simulation_options_rtl'] = current_value_225;
    }
            
    // tools -> raptor -> simulate_gate
    const current_value_226 = json_config['tools']['raptor']['simulate_gate'];
    if (current_value_226 === true || current_value_226 === false){
        default_config['tools']['raptor']['simulate_gate'] = current_value_226;
    }
            
    // tools -> raptor -> waveform_gate
    const current_value_227 = json_config['tools']['raptor']['waveform_gate'];
    if (typeof current_value_227 === 'string'){
        default_config['tools']['raptor']['waveform_gate'] = current_value_227;
    }
            
    // tools -> raptor -> simulator_gate
    const current_value_228 = json_config['tools']['raptor']['simulator_gate'];
    ...
    const current_value_229 = json_config['tools']['raptor']['simulation_options_gate'];
    if (typeof current_value_229 === 'string'){
        default_config['tools']['raptor']['simulation_options_gate'] = current_value_229;
    }
            
    // tools -> raptor -> simulate_pnr
    const current_value_230 = json_config['tools']['raptor']['simulate_pnr'];
    if (current_value_230 === true || current_value_230 === false){
        default_config['tools']['raptor']['simulate_pnr'] = current_value_230;
    }
            
    // tools -> raptor -> waveform_pnr
    const current_value_231 = json_config['tools']['raptor']['waveform_pnr'];
    if (typeof current_value_231 === 'string'){
        default_config['tools']['raptor']['waveform_pnr'] = current_value_231;
    }
            
    // tools -> raptor -> simulator_pnr
    const current_value_232 = json_config['tools']['raptor']['simulator_pnr'];
    ...
    const current_value_233 = json_config['tools']['raptor']['simulation_options_pnr'];
    if (typeof current_value_233 === 'string'){
        default_config['tools']['raptor']['simulation_options_pnr'] = current_value_233;
    }
