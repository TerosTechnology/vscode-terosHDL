...
export function get_config_from_json(json_config: any): e_config {
    ...
    const current_value_2 = json_config['general']['general']['makepath'];
    if (typeof current_value_2 === 'string'){
        default_config['general']['general']['makepath'] = current_value_2;
    }
            
    // general -> general -> go_to_definition_vhdl
    const current_value_3 = json_config['general']['general']['go_to_definition_vhdl'];
    if (current_value_3 === true || current_value_3 === false){
        default_config['general']['general']['go_to_definition_vhdl'] = current_value_3;
    }
            
    // general -> general -> go_to_definition_verilog
    const current_value_4 = json_config['general']['general']['go_to_definition_verilog'];
    if (current_value_4 === true || current_value_4 === false){
        default_config['general']['general']['go_to_definition_verilog'] = current_value_4;
    }
            
    // general -> general -> developer_mode
    const current_value_5 = json_config['general']['general']['developer_mode'];
    if (current_value_5 === true || current_value_5 === false){
        default_config['general']['general']['developer_mode'] = current_value_5;
    }
            
    // documentation -> general -> language
    const current_value_6 = json_config['documentation']['general']['language'];
    if ( current_value_6 === "english"){
        default_config['documentation']['general']['language'] = e_documentation_general_language.english;
    }
    if ( current_value_6 === "russian"){
        default_config['documentation']['general']['language'] = e_documentation_general_language.russian;
    }
            
    // documentation -> general -> symbol_vhdl
    const current_value_7 = json_config['documentation']['general']['symbol_vhdl'];
    if (typeof current_value_7 === 'string'){
        default_config['documentation']['general']['symbol_vhdl'] = current_value_7;
    }
            
    // documentation -> general -> symbol_verilog
    const current_value_8 = json_config['documentation']['general']['symbol_verilog'];
    if (typeof current_value_8 === 'string'){
        default_config['documentation']['general']['symbol_verilog'] = current_value_8;
    }
            
    // documentation -> general -> dependency_graph
    const current_value_9 = json_config['documentation']['general']['dependency_graph'];
    if (current_value_9 === true || current_value_9 === false){
        default_config['documentation']['general']['dependency_graph'] = current_value_9;
    }
            
    // documentation -> general -> self_contained
    const current_value_10 = json_config['documentation']['general']['self_contained'];
    if (current_value_10 === true || current_value_10 === false){
        default_config['documentation']['general']['self_contained'] = current_value_10;
    }
            
    // documentation -> general -> fsm
    const current_value_11 = json_config['documentation']['general']['fsm'];
    if (current_value_11 === true || current_value_11 === false){
        default_config['documentation']['general']['fsm'] = current_value_11;
    }
            
    // documentation -> general -> ports
    const current_value_12 = json_config['documentation']['general']['ports'];
    ...
    const current_value_13 = json_config['documentation']['general']['generics'];
    ...
    const current_value_14 = json_config['documentation']['general']['instantiations'];
    ...
    const current_value_15 = json_config['documentation']['general']['signals'];
    ...
    const current_value_16 = json_config['documentation']['general']['constants'];
    ...
    const current_value_17 = json_config['documentation']['general']['types'];
    ...
    const current_value_18 = json_config['documentation']['general']['process'];
    ...
    const current_value_19 = json_config['documentation']['general']['functions'];
    ...
    if ( current_value_64 === "yosys_ghdl_module"){
    ...
    const current_value_76 = json_config['tools']['osvvm']['installation_path'];
    if (typeof current_value_76 === 'string'){
        default_config['tools']['osvvm']['installation_path'] = current_value_76;
    }
            
    // tools -> osvvm -> tclsh_binary
    const current_value_77 = json_config['tools']['osvvm']['tclsh_binary'];
    if (typeof current_value_77 === 'string'){
        default_config['tools']['osvvm']['tclsh_binary'] = current_value_77;
    }
            
    // tools -> osvvm -> simulator_name
    const current_value_78 = json_config['tools']['osvvm']['simulator_name'];
    ...
    const current_value_79 = json_config['tools']['ascenlint']['installation_path'];
    if (typeof current_value_79 === 'string'){
        default_config['tools']['ascenlint']['installation_path'] = current_value_79;
    }
            
    // tools -> ascenlint -> ascentlint_options
    const current_value_80 = json_config['tools']['ascenlint']['ascentlint_options'];
    if (Array.isArray(current_value_80)){
        default_config['tools']['ascenlint']['ascentlint_options'] = current_value_80;
    }
            
    // tools -> cocotb -> installation_path
    const current_value_81 = json_config['tools']['cocotb']['installation_path'];
    if (typeof current_value_81 === 'string'){
        default_config['tools']['cocotb']['installation_path'] = current_value_81;
    }
            
    // tools -> cocotb -> simulator_name
    const current_value_82 = json_config['tools']['cocotb']['simulator_name'];
    if ( current_value_82 === "icarus"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.icarus;
    }
    if ( current_value_82 === "verilator"){
    ...
    if ( current_value_82 === "cvc"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.cvc;
    }
            
    // tools -> cocotb -> compile_args
    const current_value_83 = json_config['tools']['cocotb']['compile_args'];
    if (typeof current_value_83 === 'string'){
        default_config['tools']['cocotb']['compile_args'] = current_value_83;
    }
            
    // tools -> cocotb -> run_args
    const current_value_84 = json_config['tools']['cocotb']['run_args'];
    if (typeof current_value_84 === 'string'){
        default_config['tools']['cocotb']['run_args'] = current_value_84;
    }
            
    // tools -> cocotb -> plusargs
    const current_value_85 = json_config['tools']['cocotb']['plusargs'];
    if (typeof current_value_85 === 'string'){
        default_config['tools']['cocotb']['plusargs'] = current_value_85;
    }
            
    // tools -> diamond -> installation_path
    const current_value_86 = json_config['tools']['diamond']['installation_path'];
    if (typeof current_value_86 === 'string'){
        default_config['tools']['diamond']['installation_path'] = current_value_86;
    }
            
    // tools -> diamond -> part
    const current_value_87 = json_config['tools']['diamond']['part'];
    if (typeof current_value_87 === 'string'){
        default_config['tools']['diamond']['part'] = current_value_87;
    }
            
    // tools -> ghdl -> installation_path
    const current_value_88 = json_config['tools']['ghdl']['installation_path'];
    if (typeof current_value_88 === 'string'){
        default_config['tools']['ghdl']['installation_path'] = current_value_88;
    }
            
    // tools -> ghdl -> waveform
    const current_value_89 = json_config['tools']['ghdl']['waveform'];
    if ( current_value_89 === "vcd"){
        default_config['tools']['ghdl']['waveform'] = e_tools_ghdl_waveform.vcd;
    }
    if ( current_value_89 === "ghw"){
        default_config['tools']['ghdl']['waveform'] = e_tools_ghdl_waveform.ghw;
    }
            
    // tools -> ghdl -> analyze_options
    const current_value_90 = json_config['tools']['ghdl']['analyze_options'];
    if (Array.isArray(current_value_90)){
        default_config['tools']['ghdl']['analyze_options'] = current_value_90;
    }
            
    // tools -> ghdl -> run_options
    const current_value_91 = json_config['tools']['ghdl']['run_options'];
    if (Array.isArray(current_value_91)){
        default_config['tools']['ghdl']['run_options'] = current_value_91;
    }
            
    // tools -> icarus -> installation_path
    const current_value_92 = json_config['tools']['icarus']['installation_path'];
    if (typeof current_value_92 === 'string'){
        default_config['tools']['icarus']['installation_path'] = current_value_92;
    }
            
    // tools -> icarus -> timescale
    const current_value_93 = json_config['tools']['icarus']['timescale'];
    if (typeof current_value_93 === 'string'){
        default_config['tools']['icarus']['timescale'] = current_value_93;
    }
            
    // tools -> icarus -> iverilog_options
    const current_value_94 = json_config['tools']['icarus']['iverilog_options'];
    if (Array.isArray(current_value_94)){
        default_config['tools']['icarus']['iverilog_options'] = current_value_94;
    }
            
    // tools -> icestorm -> installation_path
    const current_value_95 = json_config['tools']['icestorm']['installation_path'];
    if (typeof current_value_95 === 'string'){
        default_config['tools']['icestorm']['installation_path'] = current_value_95;
    }
            
    // tools -> icestorm -> pnr
    const current_value_96 = json_config['tools']['icestorm']['pnr'];
    if ( current_value_96 === "arachne"){
        default_config['tools']['icestorm']['pnr'] = e_tools_icestorm_pnr.arachne;
    }
    if ( current_value_96 === "next"){
        default_config['tools']['icestorm']['pnr'] = e_tools_icestorm_pnr.next;
    }
    if ( current_value_96 === "none"){
        default_config['tools']['icestorm']['pnr'] = e_tools_icestorm_pnr.none;
    }
            
    // tools -> icestorm -> arch
    const current_value_97 = json_config['tools']['icestorm']['arch'];
    if ( current_value_97 === "xilinx"){
        default_config['tools']['icestorm']['arch'] = e_tools_icestorm_arch.xilinx;
    }
    if ( current_value_97 === "ice40"){
        default_config['tools']['icestorm']['arch'] = e_tools_icestorm_arch.ice40;
    }
    if ( current_value_97 === "ecp5"){
        default_config['tools']['icestorm']['arch'] = e_tools_icestorm_arch.ecp5;
    }
            
    // tools -> icestorm -> output_format
    const current_value_98 = json_config['tools']['icestorm']['output_format'];
    if ( current_value_98 === "json"){
        default_config['tools']['icestorm']['output_format'] = e_tools_icestorm_output_format.json;
    }
    if ( current_value_98 === "edif"){
        default_config['tools']['icestorm']['output_format'] = e_tools_icestorm_output_format.edif;
    }
    if ( current_value_98 === "blif"){
        default_config['tools']['icestorm']['output_format'] = e_tools_icestorm_output_format.blif;
    }
            
    // tools -> icestorm -> yosys_as_subtool
    const current_value_99 = json_config['tools']['icestorm']['yosys_as_subtool'];
    if (current_value_99 === true || current_value_99 === false){
        default_config['tools']['icestorm']['yosys_as_subtool'] = current_value_99;
    }
            
    // tools -> icestorm -> makefile_name
    const current_value_100 = json_config['tools']['icestorm']['makefile_name'];
    if (typeof current_value_100 === 'string'){
        default_config['tools']['icestorm']['makefile_name'] = current_value_100;
    }
            
    // tools -> icestorm -> arachne_pnr_options
    const current_value_101 = json_config['tools']['icestorm']['arachne_pnr_options'];
    if (Array.isArray(current_value_101)){
        default_config['tools']['icestorm']['arachne_pnr_options'] = current_value_101;
    }
            
    // tools -> icestorm -> nextpnr_options
    const current_value_102 = json_config['tools']['icestorm']['nextpnr_options'];
    if (Array.isArray(current_value_102)){
        default_config['tools']['icestorm']['nextpnr_options'] = current_value_102;
    }
            
    // tools -> icestorm -> yosys_synth_options
    const current_value_103 = json_config['tools']['icestorm']['yosys_synth_options'];
    if (Array.isArray(current_value_103)){
        default_config['tools']['icestorm']['yosys_synth_options'] = current_value_103;
    }
            
    // tools -> ise -> installation_path
    const current_value_104 = json_config['tools']['ise']['installation_path'];
    if (typeof current_value_104 === 'string'){
        default_config['tools']['ise']['installation_path'] = current_value_104;
    }
            
    // tools -> ise -> family
    const current_value_105 = json_config['tools']['ise']['family'];
    if (typeof current_value_105 === 'string'){
        default_config['tools']['ise']['family'] = current_value_105;
    }
            
    // tools -> ise -> device
    const current_value_106 = json_config['tools']['ise']['device'];
    if (typeof current_value_106 === 'string'){
        default_config['tools']['ise']['device'] = current_value_106;
    }
            
    // tools -> ise -> package
    const current_value_107 = json_config['tools']['ise']['package'];
    if (typeof current_value_107 === 'string'){
        default_config['tools']['ise']['package'] = current_value_107;
    }
            
    // tools -> ise -> speed
    const current_value_108 = json_config['tools']['ise']['speed'];
    if (typeof current_value_108 === 'string'){
        default_config['tools']['ise']['speed'] = current_value_108;
    }
            
    // tools -> isem -> installation_path
    const current_value_109 = json_config['tools']['isem']['installation_path'];
    if (typeof current_value_109 === 'string'){
        default_config['tools']['isem']['installation_path'] = current_value_109;
    }
            
    // tools -> isem -> fuse_options
    const current_value_110 = json_config['tools']['isem']['fuse_options'];
    if (Array.isArray(current_value_110)){
        default_config['tools']['isem']['fuse_options'] = current_value_110;
    }
            
    // tools -> isem -> isim_options
    const current_value_111 = json_config['tools']['isem']['isim_options'];
    if (Array.isArray(current_value_111)){
        default_config['tools']['isem']['isim_options'] = current_value_111;
    }
            
    // tools -> modelsim -> installation_path
    const current_value_112 = json_config['tools']['modelsim']['installation_path'];
    if (typeof current_value_112 === 'string'){
        default_config['tools']['modelsim']['installation_path'] = current_value_112;
    }
            
    // tools -> modelsim -> vcom_options
    const current_value_113 = json_config['tools']['modelsim']['vcom_options'];
    if (Array.isArray(current_value_113)){
        default_config['tools']['modelsim']['vcom_options'] = current_value_113;
    }
            
    // tools -> modelsim -> vlog_options
    const current_value_114 = json_config['tools']['modelsim']['vlog_options'];
    if (Array.isArray(current_value_114)){
        default_config['tools']['modelsim']['vlog_options'] = current_value_114;
    }
            
    // tools -> modelsim -> vsim_options
    const current_value_115 = json_config['tools']['modelsim']['vsim_options'];
    if (Array.isArray(current_value_115)){
        default_config['tools']['modelsim']['vsim_options'] = current_value_115;
    }
            
    // tools -> morty -> installation_path
    const current_value_116 = json_config['tools']['morty']['installation_path'];
    if (typeof current_value_116 === 'string'){
        default_config['tools']['morty']['installation_path'] = current_value_116;
    }
            
    // tools -> morty -> morty_options
    const current_value_117 = json_config['tools']['morty']['morty_options'];
    if (Array.isArray(current_value_117)){
        default_config['tools']['morty']['morty_options'] = current_value_117;
    }
            
    // tools -> quartus -> installation_path
    const current_value_118 = json_config['tools']['quartus']['installation_path'];
    if (typeof current_value_118 === 'string'){
        default_config['tools']['quartus']['installation_path'] = current_value_118;
    }
            
    // tools -> quartus -> family
    const current_value_119 = json_config['tools']['quartus']['family'];
    if (typeof current_value_119 === 'string'){
        default_config['tools']['quartus']['family'] = current_value_119;
    }
            
    // tools -> quartus -> device
    const current_value_120 = json_config['tools']['quartus']['device'];
    if (typeof current_value_120 === 'string'){
        default_config['tools']['quartus']['device'] = current_value_120;
    }
            
    // tools -> quartus -> cable
    const current_value_121 = json_config['tools']['quartus']['cable'];
    if (typeof current_value_121 === 'string'){
        default_config['tools']['quartus']['cable'] = current_value_121;
    }
            
    // tools -> quartus -> board_device_index
    const current_value_122 = json_config['tools']['quartus']['board_device_index'];
    if (typeof current_value_122 === 'string'){
        default_config['tools']['quartus']['board_device_index'] = current_value_122;
    }
            
    // tools -> quartus -> pnr
    const current_value_123 = json_config['tools']['quartus']['pnr'];
    if ( current_value_123 === "default"){
        default_config['tools']['quartus']['pnr'] = e_tools_quartus_pnr.default;
    }
    if ( current_value_123 === "dse"){
        default_config['tools']['quartus']['pnr'] = e_tools_quartus_pnr.dse;
    }
    if ( current_value_123 === "none"){
        default_config['tools']['quartus']['pnr'] = e_tools_quartus_pnr.none;
    }
            
    // tools -> quartus -> dse_options
    const current_value_124 = json_config['tools']['quartus']['dse_options'];
    if (Array.isArray(current_value_124)){
        default_config['tools']['quartus']['dse_options'] = current_value_124;
    }
            
    // tools -> quartus -> quartus_options
    const current_value_125 = json_config['tools']['quartus']['quartus_options'];
    if (Array.isArray(current_value_125)){
        default_config['tools']['quartus']['quartus_options'] = current_value_125;
    }
