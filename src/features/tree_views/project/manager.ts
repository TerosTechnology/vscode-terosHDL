...
export class Project_manager {
    ...
    async add_project(item: element.Project) {
        ...
        // Load from JSON EDAM
            ...
            const path_list = await utils.get_from_open_dialog(false, true, true, 'Select JSON EDAM files', {
        ...
        // Load from YAML EDAM
            ...
            const path_list = await utils.get_from_open_dialog(false, true, true, 'Select YAML EDAM files', {
        ...
        // Load an example
            ...
            if (picker_value !== undefined) {
                ...
                const project_path = path_lib.join(
                    __filename,
                    '..',
                    '..',
                    '..',
