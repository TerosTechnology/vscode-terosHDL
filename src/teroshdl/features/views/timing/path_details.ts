...
import { t_timing_node } from 'colibri/project_manager/common';
import { read_file_sync } from 'colibri/utils/file_utils';

export function getPathDetailsView(context: vscode.ExtensionContext, projectManager: Multi_project_manager): PathDetailsView {
...
export class PathDetailsView {
    ...
    private pathDetails: t_timing_node[] = [];
    ...
    async showPathDetails(slack: number, pathDetails: t_timing_node[], 
        pathName: string) {
    ...
    private async sendPathDetails(pathDetails: t_timing_node[]) {
