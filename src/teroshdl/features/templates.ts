...
import { get_template_definition } from 'colibri/template/common';
import * as templateManager from 'colibri/template/manager';
import { t_template_options } from 'colibri/config/auxiliar_config';
...
export class Template_manager {
    ...
    async get_template() {
        ...
        const template_names = get_template_definition(lang);
        ...
        let select_id = '';
        let lang_template = LANGUAGE.VHDL;
        ...
        const template_manager = new templateManager.Template_manager(lang);
    ...
    // Utils
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    private get_indent(general_indent: string, lang: LANGUAGE): string {
    ...
    private get_config(): t_template_options {
        const config = utils.getConfig(this.manager);
        return <t_template_options>{
