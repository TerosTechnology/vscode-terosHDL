...
export class Output extends vscode.TreeItem {
    ...
    constructor(name: string, path: string, successful: boolean | undefined,
        artifact_type: e_artifact_type | undefined,
        element_type: e_element_type | undefined,
        ...
        else if (artifact_type === e_artifact_type.CONSOLE_LOG) {
        ...
        else if (artifact_type === e_artifact_type.SUMMARY &&
            element_type === e_element_type.HTML) {
        ...
        else if (artifact_type === e_artifact_type.WAVEFORM) {
        ...
        else if (element_type === e_element_type.FOLDER) {
