...
export function get_config_from_json(json_config: any): e_config {
    ...
    const current_value_90 = json_config['tools']['ascenlint']['installation_path'];
    ...
    const current_value_91 = json_config['tools']['ascenlint']['ascentlint_options'];
    ...
    const current_value_92 = json_config['tools']['cocotb']['installation_path'];
    ...
    const current_value_93 = json_config['tools']['cocotb']['simulator_name'];
    ...
    const current_value_106 = json_config['tools']['icestorm']['installation_path'];
    if (typeof current_value_106 === 'string'){
        default_config['tools']['icestorm']['installation_path'] = current_value_106;
    }
            
    // tools -> icestorm -> pnr
    const current_value_107 = json_config['tools']['icestorm']['pnr'];
    ...
    // tools -> icestorm -> arch
    const current_value_108 = json_config['tools']['icestorm']['arch'];
    ...
    const current_value_109 = json_config['tools']['icestorm']['output_format'];
    ...
    const current_value_110 = json_config['tools']['icestorm']['yosys_as_subtool'];
    ...
    const current_value_111 = json_config['tools']['icestorm']['makefile_name'];
    ...
    const current_value_112 = json_config['tools']['icestorm']['arachne_pnr_options'];
    ...
    const current_value_113 = json_config['tools']['icestorm']['nextpnr_options'];
    ...
    const current_value_114 = json_config['tools']['icestorm']['yosys_synth_options'];
    ...
    const current_value_123 = json_config['tools']['modelsim']['installation_path'];
    ...
    const current_value_124 = json_config['tools']['modelsim']['vcom_options'];
    ...
    const current_value_125 = json_config['tools']['modelsim']['vlog_options'];
    ...
    const current_value_126 = json_config['tools']['modelsim']['vsim_options'];
    ...
    const current_value_127 = json_config['tools']['morty']['installation_path'];
    ...
    const current_value_128 = json_config['tools']['morty']['morty_options'];
    ...
    const current_value_132 = json_config['tools']['rivierapro']['compilation_mode'];
    ...
    const current_value_133 = json_config['tools']['rivierapro']['vlog_options'];
    ...
    const current_value_134 = json_config['tools']['rivierapro']['vsim_options'];
    ...
    if (typeof current_value_199 === 'string'){
        default_config['tools']['openfpga']['arch'] = current_value_199;
    }
            
    // tools -> openfpga -> task_options
    const current_value_200 = json_config['tools']['openfpga']['task_options'];
    if (Array.isArray(current_value_200)){
        default_config['tools']['openfpga']['task_options'] = current_value_200;
    }
    ...
    const current_value_213 = json_config['tools']['raptor']['pnr_netlist_language'];
    if ( current_value_213 === "blif"){
        default_config['tools']['raptor']['pnr_netlist_language'] = e_tools_raptor_pnr_netlist_language.blif;
    }
    if ( current_value_213 === "edif"){
        default_config['tools']['raptor']['pnr_netlist_language'] = e_tools_raptor_pnr_netlist_language.edif;
    }
    if ( current_value_213 === "verilog"){
        default_config['tools']['raptor']['pnr_netlist_language'] = e_tools_raptor_pnr_netlist_language.verilog;
    }
    if ( current_value_213 === "vhdl"){
        default_config['tools']['raptor']['pnr_netlist_language'] = e_tools_raptor_pnr_netlist_language.vhdl;
    }
            
    // tools -> raptor -> dsp_limit
    const current_value_214 = json_config['tools']['raptor']['dsp_limit'];
    if (typeof current_value_214 === 'number'){
        default_config['tools']['raptor']['dsp_limit'] = current_value_214;
    }
            
    // tools -> raptor -> block_ram_limit
    const current_value_215 = json_config['tools']['raptor']['block_ram_limit'];
    if (typeof current_value_215 === 'number'){
        default_config['tools']['raptor']['block_ram_limit'] = current_value_215;
    }
            
    // tools -> raptor -> fast_synthesis
    const current_value_216 = json_config['tools']['raptor']['fast_synthesis'];
    if (current_value_216 === true || current_value_216 === false){
        default_config['tools']['raptor']['fast_synthesis'] = current_value_216;
    }
            
    // tools -> raptor -> div_1
            
    // tools -> raptor -> top_level
    const current_value_218 = json_config['tools']['raptor']['top_level'];
    if (typeof current_value_218 === 'string'){
        default_config['tools']['raptor']['top_level'] = current_value_218;
    }
            
    // tools -> raptor -> sim_source_list
    const current_value_219 = json_config['tools']['raptor']['sim_source_list'];
    if (Array.isArray(current_value_219)){
        default_config['tools']['raptor']['sim_source_list'] = current_value_219;
    }
            
    // tools -> raptor -> simulate_rtl
    const current_value_220 = json_config['tools']['raptor']['simulate_rtl'];
    if (current_value_220 === true || current_value_220 === false){
        default_config['tools']['raptor']['simulate_rtl'] = current_value_220;
    }
            
    // tools -> raptor -> waveform_rtl
    const current_value_221 = json_config['tools']['raptor']['waveform_rtl'];
    if (typeof current_value_221 === 'string'){
        default_config['tools']['raptor']['waveform_rtl'] = current_value_221;
    }
            
    // tools -> raptor -> simulator_rtl
    const current_value_222 = json_config['tools']['raptor']['simulator_rtl'];
    ...
    const current_value_223 = json_config['tools']['raptor']['simulation_options_rtl'];
    if (typeof current_value_223 === 'string'){
        default_config['tools']['raptor']['simulation_options_rtl'] = current_value_223;
    }
            
    // tools -> raptor -> simulate_gate
    const current_value_224 = json_config['tools']['raptor']['simulate_gate'];
    if (current_value_224 === true || current_value_224 === false){
        default_config['tools']['raptor']['simulate_gate'] = current_value_224;
    }
            
    // tools -> raptor -> waveform_gate
    const current_value_225 = json_config['tools']['raptor']['waveform_gate'];
    if (typeof current_value_225 === 'string'){
        default_config['tools']['raptor']['waveform_gate'] = current_value_225;
    }
            
    // tools -> raptor -> simulator_gate
    const current_value_226 = json_config['tools']['raptor']['simulator_gate'];
    ...
    const current_value_227 = json_config['tools']['raptor']['simulation_options_gate'];
    if (typeof current_value_227 === 'string'){
        default_config['tools']['raptor']['simulation_options_gate'] = current_value_227;
    }
            
    // tools -> raptor -> simulate_pnr
    const current_value_228 = json_config['tools']['raptor']['simulate_pnr'];
    if (current_value_228 === true || current_value_228 === false){
        default_config['tools']['raptor']['simulate_pnr'] = current_value_228;
    }
            
    // tools -> raptor -> waveform_pnr
    const current_value_229 = json_config['tools']['raptor']['waveform_pnr'];
    if (typeof current_value_229 === 'string'){
        default_config['tools']['raptor']['waveform_pnr'] = current_value_229;
    }
            
    // tools -> raptor -> simulator_pnr
    const current_value_230 = json_config['tools']['raptor']['simulator_pnr'];
    ...
    const current_value_231 = json_config['tools']['raptor']['simulation_options_pnr'];
    if (typeof current_value_231 === 'string'){
        default_config['tools']['raptor']['simulation_options_pnr'] = current_value_231;
    }
