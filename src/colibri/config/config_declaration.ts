...
export function get_config_from_json(json_config: any): e_config {
    ...
    const current_value_56 = json_config['linter']['ghdl']['arguments'];
    if (typeof current_value_56 === 'string'){
        default_config['linter']['ghdl']['arguments'] = current_value_56;
    }
            
    // linter -> icarus -> arguments
    const current_value_57 = json_config['linter']['icarus']['arguments'];
    if (typeof current_value_57 === 'string'){
        default_config['linter']['icarus']['arguments'] = current_value_57;
    }
            
    // linter -> modelsim -> vhdl_arguments
    const current_value_58 = json_config['linter']['modelsim']['vhdl_arguments'];
    ...
    const current_value_59 = json_config['linter']['modelsim']['verilog_arguments'];
    ...
    const current_value_63 = json_config['linter']['vivado']['verilog_arguments'];
    if (typeof current_value_63 === 'string'){
        default_config['linter']['vivado']['verilog_arguments'] = current_value_63;
    }
            
    // linter -> vsg -> arguments
    const current_value_64 = json_config['linter']['vsg']['arguments'];
    if (typeof current_value_64 === 'string'){
        default_config['linter']['vsg']['arguments'] = current_value_64;
    }
            
    // schematic -> general -> backend
    const current_value_65 = json_config['schematic']['general']['backend'];
    if ( current_value_65 === "yowasp"){
        default_config['schematic']['general']['backend'] = e_schematic_general_backend.yowasp;
    }
    if ( current_value_65 === "yosys"){
        default_config['schematic']['general']['backend'] = e_schematic_general_backend.yosys;
    }
    if ( current_value_65 === "yosys_ghdl"){
        default_config['schematic']['general']['backend'] = e_schematic_general_backend.yosys_ghdl;
    }
    if ( current_value_65 === "standalone"){
        default_config['schematic']['general']['backend'] = e_schematic_general_backend.standalone;
    }
            
    // schematic -> general -> extra
    const current_value_66 = json_config['schematic']['general']['extra'];
    if (typeof current_value_66 === 'string'){
        default_config['schematic']['general']['extra'] = current_value_66;
    }
            
    // schematic -> general -> args
    const current_value_67 = json_config['schematic']['general']['args'];
    if (typeof current_value_67 === 'string'){
        default_config['schematic']['general']['args'] = current_value_67;
    }
            
    // schematic -> general -> args_ghdl
    const current_value_68 = json_config['schematic']['general']['args_ghdl'];
    if (typeof current_value_68 === 'string'){
        default_config['schematic']['general']['args_ghdl'] = current_value_68;
    }
            
    // templates -> general -> header_file_path
    const current_value_69 = json_config['templates']['general']['header_file_path'];
    if (typeof current_value_69 === 'string'){
        default_config['templates']['general']['header_file_path'] = current_value_69;
    }
            
    // templates -> general -> indent
    const current_value_70 = json_config['templates']['general']['indent'];
    if (typeof current_value_70 === 'string'){
        default_config['templates']['general']['indent'] = current_value_70;
    }
            
    // templates -> general -> clock_generation_style
    const current_value_71 = json_config['templates']['general']['clock_generation_style'];
    ...
    const current_value_77 = json_config['tools']['general']['gtkwave_installation_path'];
    if (typeof current_value_77 === 'string'){
        default_config['tools']['general']['gtkwave_installation_path'] = current_value_77;
    }
            
    // tools -> general -> gtkwave_extra_arguments
    const current_value_78 = json_config['tools']['general']['gtkwave_extra_arguments'];
    if (typeof current_value_78 === 'string'){
        default_config['tools']['general']['gtkwave_extra_arguments'] = current_value_78;
    }
            
    // tools -> quartus -> installation_path
    const current_value_79 = json_config['tools']['quartus']['installation_path'];
    if (typeof current_value_79 === 'string'){
        default_config['tools']['quartus']['installation_path'] = current_value_79;
    }
            
    // tools -> quartus -> family
    const current_value_80 = json_config['tools']['quartus']['family'];
    if (typeof current_value_80 === 'string'){
        default_config['tools']['quartus']['family'] = current_value_80;
    }
            
    // tools -> quartus -> device
    const current_value_81 = json_config['tools']['quartus']['device'];
    if (typeof current_value_81 === 'string'){
        default_config['tools']['quartus']['device'] = current_value_81;
    }
            
    // tools -> quartus -> optimization_mode
    const current_value_82 = json_config['tools']['quartus']['optimization_mode'];
    if ( current_value_82 === "BALANCED"){
        default_config['tools']['quartus']['optimization_mode'] = e_tools_quartus_optimization_mode.BALANCED;
    }
    if ( current_value_82 === "HIGH_PERFORMANCE_EFFORT"){
        default_config['tools']['quartus']['optimization_mode'] = e_tools_quartus_optimization_mode.HIGH_PERFORMANCE_EFFORT;
    }
    if ( current_value_82 === "HIGH_PERFORMANCE_EFFORT_WITH_MAXIMUM_PLACEMENT_EFFORT"){
    ...
    if ( current_value_82 === "HIGH_PERFORMANCE_WITH_AGGRESSIVE_POWER_EFFORT"){
    ...
    if ( current_value_82 === "SUPERIOR_PERFORMANCE"){
        default_config['tools']['quartus']['optimization_mode'] = e_tools_quartus_optimization_mode.SUPERIOR_PERFORMANCE;
    }
    if ( current_value_82 === "SUPERIOR_PERFORMANCE_WITH_MAXIMUM_PLACEMENT_EFFORT"){
    ...
    const current_value_83 = json_config['tools']['quartus']['allow_register_retiming'];
    if (current_value_83 === true || current_value_83 === false){
        default_config['tools']['quartus']['allow_register_retiming'] = current_value_83;
    }
            
    // tools -> quartus -> wave_file_questa
    const current_value_84 = json_config['tools']['quartus']['wave_file_questa'];
    if (typeof current_value_84 === 'string'){
        default_config['tools']['quartus']['wave_file_questa'] = current_value_84;
    }
            
    // tools -> osvvm -> installation_path
    const current_value_85 = json_config['tools']['osvvm']['installation_path'];
    if (typeof current_value_85 === 'string'){
        default_config['tools']['osvvm']['installation_path'] = current_value_85;
    }
            
    // tools -> osvvm -> tclsh_binary
    const current_value_86 = json_config['tools']['osvvm']['tclsh_binary'];
    if (typeof current_value_86 === 'string'){
        default_config['tools']['osvvm']['tclsh_binary'] = current_value_86;
    }
            
    // tools -> osvvm -> simulator_name
    const current_value_87 = json_config['tools']['osvvm']['simulator_name'];
    ...
    const current_value_88 = json_config['tools']['ascenlint']['installation_path'];
    if (typeof current_value_88 === 'string'){
        default_config['tools']['ascenlint']['installation_path'] = current_value_88;
    }
            
    // tools -> ascenlint -> ascentlint_options
    const current_value_89 = json_config['tools']['ascenlint']['ascentlint_options'];
    if (Array.isArray(current_value_89)){
        default_config['tools']['ascenlint']['ascentlint_options'] = current_value_89;
    }
            
    // tools -> cocotb -> installation_path
    const current_value_90 = json_config['tools']['cocotb']['installation_path'];
    if (typeof current_value_90 === 'string'){
        default_config['tools']['cocotb']['installation_path'] = current_value_90;
    }
            
    // tools -> cocotb -> simulator_name
    const current_value_91 = json_config['tools']['cocotb']['simulator_name'];
    if ( current_value_91 === "icarus"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.icarus;
    }
    if ( current_value_91 === "verilator"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.verilator;
    }
    if ( current_value_91 === "vcs"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.vcs;
    }
    if ( current_value_91 === "riviera"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.riviera;
    }
    if ( current_value_91 === "activehdl"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.activehdl;
    }
    if ( current_value_91 === "questa"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.questa;
    }
    if ( current_value_91 === "modelsim"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.modelsim;
    }
    if ( current_value_91 === "ius"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.ius;
    }
    if ( current_value_91 === "xcelium"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.xcelium;
    }
    if ( current_value_91 === "ghdl"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.ghdl;
    }
    if ( current_value_91 === "cvc"){
        default_config['tools']['cocotb']['simulator_name'] = e_tools_cocotb_simulator_name.cvc;
    }
            
    // tools -> cocotb -> compile_args
    const current_value_92 = json_config['tools']['cocotb']['compile_args'];
    if (typeof current_value_92 === 'string'){
        default_config['tools']['cocotb']['compile_args'] = current_value_92;
    }
            
    // tools -> cocotb -> run_args
    const current_value_93 = json_config['tools']['cocotb']['run_args'];
    if (typeof current_value_93 === 'string'){
        default_config['tools']['cocotb']['run_args'] = current_value_93;
    }
            
    // tools -> cocotb -> plusargs
    const current_value_94 = json_config['tools']['cocotb']['plusargs'];
    if (typeof current_value_94 === 'string'){
        default_config['tools']['cocotb']['plusargs'] = current_value_94;
    }
            
    // tools -> diamond -> installation_path
    const current_value_95 = json_config['tools']['diamond']['installation_path'];
    if (typeof current_value_95 === 'string'){
        default_config['tools']['diamond']['installation_path'] = current_value_95;
    }
            
    // tools -> diamond -> part
    const current_value_96 = json_config['tools']['diamond']['part'];
    if (typeof current_value_96 === 'string'){
        default_config['tools']['diamond']['part'] = current_value_96;
    }
            
    // tools -> ghdl -> installation_path
    const current_value_97 = json_config['tools']['ghdl']['installation_path'];
    if (typeof current_value_97 === 'string'){
        default_config['tools']['ghdl']['installation_path'] = current_value_97;
    }
            
    // tools -> ghdl -> waveform
    const current_value_98 = json_config['tools']['ghdl']['waveform'];
    if ( current_value_98 === "vcd"){
        default_config['tools']['ghdl']['waveform'] = e_tools_ghdl_waveform.vcd;
    }
    if ( current_value_98 === "ghw"){
        default_config['tools']['ghdl']['waveform'] = e_tools_ghdl_waveform.ghw;
    }
            
    // tools -> ghdl -> analyze_options
    const current_value_99 = json_config['tools']['ghdl']['analyze_options'];
    if (Array.isArray(current_value_99)){
        default_config['tools']['ghdl']['analyze_options'] = current_value_99;
    }
            
    // tools -> ghdl -> run_options
    const current_value_100 = json_config['tools']['ghdl']['run_options'];
    if (Array.isArray(current_value_100)){
        default_config['tools']['ghdl']['run_options'] = current_value_100;
    }
            
    // tools -> icarus -> installation_path
    const current_value_101 = json_config['tools']['icarus']['installation_path'];
    if (typeof current_value_101 === 'string'){
        default_config['tools']['icarus']['installation_path'] = current_value_101;
    }
            
    // tools -> icarus -> timescale
    const current_value_102 = json_config['tools']['icarus']['timescale'];
    if (typeof current_value_102 === 'string'){
        default_config['tools']['icarus']['timescale'] = current_value_102;
    }
            
    // tools -> icarus -> iverilog_options
    const current_value_103 = json_config['tools']['icarus']['iverilog_options'];
    if (Array.isArray(current_value_103)){
        default_config['tools']['icarus']['iverilog_options'] = current_value_103;
    }
            
    // tools -> icestorm -> installation_path
    const current_value_104 = json_config['tools']['icestorm']['installation_path'];
    if (typeof current_value_104 === 'string'){
        default_config['tools']['icestorm']['installation_path'] = current_value_104;
    }
            
    // tools -> icestorm -> pnr
    const current_value_105 = json_config['tools']['icestorm']['pnr'];
    if ( current_value_105 === "arachne"){
        default_config['tools']['icestorm']['pnr'] = e_tools_icestorm_pnr.arachne;
    }
    if ( current_value_105 === "next"){
        default_config['tools']['icestorm']['pnr'] = e_tools_icestorm_pnr.next;
    }
    if ( current_value_105 === "none"){
        default_config['tools']['icestorm']['pnr'] = e_tools_icestorm_pnr.none;
    }
            
    // tools -> icestorm -> arch
    const current_value_106 = json_config['tools']['icestorm']['arch'];
    if ( current_value_106 === "xilinx"){
        default_config['tools']['icestorm']['arch'] = e_tools_icestorm_arch.xilinx;
    }
    if ( current_value_106 === "ice40"){
        default_config['tools']['icestorm']['arch'] = e_tools_icestorm_arch.ice40;
    }
    if ( current_value_106 === "ecp5"){
        default_config['tools']['icestorm']['arch'] = e_tools_icestorm_arch.ecp5;
    }
            
    // tools -> icestorm -> output_format
    const current_value_107 = json_config['tools']['icestorm']['output_format'];
    if ( current_value_107 === "json"){
        default_config['tools']['icestorm']['output_format'] = e_tools_icestorm_output_format.json;
    }
    if ( current_value_107 === "edif"){
        default_config['tools']['icestorm']['output_format'] = e_tools_icestorm_output_format.edif;
    }
    if ( current_value_107 === "blif"){
        default_config['tools']['icestorm']['output_format'] = e_tools_icestorm_output_format.blif;
    }
            
    // tools -> icestorm -> yosys_as_subtool
    const current_value_108 = json_config['tools']['icestorm']['yosys_as_subtool'];
    if (current_value_108 === true || current_value_108 === false){
        default_config['tools']['icestorm']['yosys_as_subtool'] = current_value_108;
    }
            
    // tools -> icestorm -> makefile_name
    const current_value_109 = json_config['tools']['icestorm']['makefile_name'];
    if (typeof current_value_109 === 'string'){
        default_config['tools']['icestorm']['makefile_name'] = current_value_109;
    }
            
    // tools -> icestorm -> arachne_pnr_options
    const current_value_110 = json_config['tools']['icestorm']['arachne_pnr_options'];
    if (Array.isArray(current_value_110)){
        default_config['tools']['icestorm']['arachne_pnr_options'] = current_value_110;
    }
            
    // tools -> icestorm -> nextpnr_options
    const current_value_111 = json_config['tools']['icestorm']['nextpnr_options'];
    if (Array.isArray(current_value_111)){
        default_config['tools']['icestorm']['nextpnr_options'] = current_value_111;
    }
            
    // tools -> icestorm -> yosys_synth_options
    const current_value_112 = json_config['tools']['icestorm']['yosys_synth_options'];
    if (Array.isArray(current_value_112)){
        default_config['tools']['icestorm']['yosys_synth_options'] = current_value_112;
    }
            
    // tools -> ise -> installation_path
    const current_value_113 = json_config['tools']['ise']['installation_path'];
    if (typeof current_value_113 === 'string'){
        default_config['tools']['ise']['installation_path'] = current_value_113;
    }
            
    // tools -> ise -> family
    const current_value_114 = json_config['tools']['ise']['family'];
    if (typeof current_value_114 === 'string'){
        default_config['tools']['ise']['family'] = current_value_114;
    }
            
    // tools -> ise -> device
    const current_value_115 = json_config['tools']['ise']['device'];
    if (typeof current_value_115 === 'string'){
        default_config['tools']['ise']['device'] = current_value_115;
    }
            
    // tools -> ise -> package
    const current_value_116 = json_config['tools']['ise']['package'];
    if (typeof current_value_116 === 'string'){
        default_config['tools']['ise']['package'] = current_value_116;
    }
            
    // tools -> ise -> speed
    const current_value_117 = json_config['tools']['ise']['speed'];
    if (typeof current_value_117 === 'string'){
        default_config['tools']['ise']['speed'] = current_value_117;
    }
            
    // tools -> isem -> installation_path
    const current_value_118 = json_config['tools']['isem']['installation_path'];
    if (typeof current_value_118 === 'string'){
        default_config['tools']['isem']['installation_path'] = current_value_118;
    }
            
    // tools -> isem -> fuse_options
    const current_value_119 = json_config['tools']['isem']['fuse_options'];
    if (Array.isArray(current_value_119)){
        default_config['tools']['isem']['fuse_options'] = current_value_119;
    }
            
    // tools -> isem -> isim_options
    const current_value_120 = json_config['tools']['isem']['isim_options'];
    if (Array.isArray(current_value_120)){
        default_config['tools']['isem']['isim_options'] = current_value_120;
    }
            
    // tools -> modelsim -> installation_path
    const current_value_121 = json_config['tools']['modelsim']['installation_path'];
    if (typeof current_value_121 === 'string'){
        default_config['tools']['modelsim']['installation_path'] = current_value_121;
    }
            
    // tools -> modelsim -> vcom_options
    const current_value_122 = json_config['tools']['modelsim']['vcom_options'];
    if (Array.isArray(current_value_122)){
        default_config['tools']['modelsim']['vcom_options'] = current_value_122;
    }
            
    // tools -> modelsim -> vlog_options
    const current_value_123 = json_config['tools']['modelsim']['vlog_options'];
    if (Array.isArray(current_value_123)){
        default_config['tools']['modelsim']['vlog_options'] = current_value_123;
    }
            
    // tools -> modelsim -> vsim_options
    const current_value_124 = json_config['tools']['modelsim']['vsim_options'];
    if (Array.isArray(current_value_124)){
        default_config['tools']['modelsim']['vsim_options'] = current_value_124;
    }
            
    // tools -> morty -> installation_path
    const current_value_125 = json_config['tools']['morty']['installation_path'];
    if (typeof current_value_125 === 'string'){
        default_config['tools']['morty']['installation_path'] = current_value_125;
    }
            
    // tools -> morty -> morty_options
    const current_value_126 = json_config['tools']['morty']['morty_options'];
    if (Array.isArray(current_value_126)){
        default_config['tools']['morty']['morty_options'] = current_value_126;
    }
            
    // tools -> radiant -> installation_path
    const current_value_127 = json_config['tools']['radiant']['installation_path'];
    if (typeof current_value_127 === 'string'){
        default_config['tools']['radiant']['installation_path'] = current_value_127;
    }
            
    // tools -> radiant -> part
    const current_value_128 = json_config['tools']['radiant']['part'];
    if (typeof current_value_128 === 'string'){
        default_config['tools']['radiant']['part'] = current_value_128;
    }
            
    // tools -> rivierapro -> installation_path
    const current_value_129 = json_config['tools']['rivierapro']['installation_path'];
    if (typeof current_value_129 === 'string'){
        default_config['tools']['rivierapro']['installation_path'] = current_value_129;
    }
            
    // tools -> rivierapro -> compilation_mode
    const current_value_130 = json_config['tools']['rivierapro']['compilation_mode'];
    if (typeof current_value_130 === 'string'){
        default_config['tools']['rivierapro']['compilation_mode'] = current_value_130;
    }
            
    // tools -> rivierapro -> vlog_options
    const current_value_131 = json_config['tools']['rivierapro']['vlog_options'];
    if (Array.isArray(current_value_131)){
        default_config['tools']['rivierapro']['vlog_options'] = current_value_131;
    }
            
    // tools -> rivierapro -> vsim_options
    const current_value_132 = json_config['tools']['rivierapro']['vsim_options'];
    if (Array.isArray(current_value_132)){
        default_config['tools']['rivierapro']['vsim_options'] = current_value_132;
    }
    ...
    if (typeof current_value_197 === 'string'){
        default_config['tools']['openfpga']['arch'] = current_value_197;
    }
            
    // tools -> openfpga -> task_options
    const current_value_198 = json_config['tools']['openfpga']['task_options'];
    if (Array.isArray(current_value_198)){
        default_config['tools']['openfpga']['task_options'] = current_value_198;
    }
            
    // tools -> activehdl -> installation_path
    const current_value_199 = json_config['tools']['activehdl']['installation_path'];
    if (typeof current_value_199 === 'string'){
        default_config['tools']['activehdl']['installation_path'] = current_value_199;
    }
