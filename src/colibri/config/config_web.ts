...
<body>
    <div class="settings-editor">
        ...
        <div class="settings-body">
                ...
                <div class="settings-toc-container">
                    ...
                    <div class="settings-toc-entry" id="toc-tools">
                        ...
                        <div class="settings-toc-children" id="children-tools">
                            ...
                            <div class="settings-toc-child" id="btn-tools-nvc">
                                NVC
                            </div>
            ...
            <div class="settings-section" id="tools-nvc">
                <div class="settings-group-title-label">
                    Tools: NVC
                </div>
                <div class="settings-group-description">NVC is an open source VHDL compiler and simulator.</div>
                  
                    <hr class="setting-divider">
                    <div class="setting-divider-title">Basic NVC Configuration</div>
                    <hr class="setting-divider">
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Installation path:
                            <span class="markConfig" id="mark_tools-nvc-installation_path"></span>
                        </div>
                            <input class="setting-input-box" id="tools-nvc-installation_path" value="">
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            IEEE library to use:
                            <span class="markConfig" id="mark_tools-nvc-ieee_library"></span>
                        </div>
                        <div class="select-container">
                            <select class="setting-select-box" id="tools-nvc-ieee_library">
                                      <option value='standard'>Standard IEEE</option>
                                      <option value='synopsys'>Synopsys IEEE</option>
                            </select>
                        </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-checkbox">
                            <input type="checkbox" id="tools-nvc-relaxed_parsing">
                            <label class="setting-checkbox-label" for="tools-nvc-relaxed_parsing">
                                Enable relaxed VHDL parsing rules:
                                <span class="markConfig" id="mark_tools-nvc-relaxed_parsing"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-checkbox">
                            <input type="checkbox" id="tools-nvc-unicode_support">
                            <label class="setting-checkbox-label" for="tools-nvc-unicode_support">
                                Enable Unicode identifiers support:
                                <span class="markConfig" id="mark_tools-nvc-unicode_support"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-checkbox">
                            <input type="checkbox" id="tools-nvc-psl_enabled">
                            <label class="setting-checkbox-label" for="tools-nvc-psl_enabled">
                                Enable PSL (Property Specification Language) support:
                                <span class="markConfig" id="mark_tools-nvc-psl_enabled"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Default work library name:
                            <span class="markConfig" id="mark_tools-nvc-work_library"></span>
                        </div>
                            <input class="setting-input-box" id="tools-nvc-work_library" value="work">
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Additional library search paths:
                            <span class="markConfig" id="mark_tools-nvc-library_paths"></span>
                        </div>
                        <div class="setting-item-description">Comma separated values</div>
                        <input class="setting-input-box" id="tools-nvc-library_paths">
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Check syntax options. Extra options used for NVC syntax check (nvc -s).
                            <span class="markConfig" id="mark_tools-nvc-check_syntax_options"></span>
                        </div>
                        <div class="setting-item-description">Comma separated values</div>
                        <input class="setting-input-box" id="tools-nvc-check_syntax_options">
                    </div>
                  
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Analyze options. Extra options used for the NVC analyze stage (nvc -a).
                            <span class="markConfig" id="mark_tools-nvc-analyze_options"></span>
                        </div>
                        <div class="setting-item-description">Comma separated values</div>
                        <input class="setting-input-box" id="tools-nvc-analyze_options">
                    </div>
                  
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Elaborate options. Extra options used for the NVC elaborate stage (nvc -e).
                            <span class="markConfig" id="mark_tools-nvc-elaborate_options"></span>
                        </div>
                        <div class="setting-item-description">Comma separated values</div>
                        <input class="setting-input-box" id="tools-nvc-elaborate_options">
                    </div>
                  
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Run options. Extra options used when running NVC simulations (nvc -r).
                            <span class="markConfig" id="mark_tools-nvc-run_options"></span>
                        </div>
                        <div class="setting-item-description">Comma separated values</div>
                        <input class="setting-input-box" id="tools-nvc-run_options">
                    </div>
                  
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Synthesis options for NVC synthesis (nvc --synth):
                            <span class="markConfig" id="mark_tools-nvc-synthesis_options"></span>
                        </div>
                        <div class="setting-item-description">Comma separated values</div>
                        <input class="setting-input-box" id="tools-nvc-synthesis_options">
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Additional custom flags for all NVC commands:
                            <span class="markConfig" id="mark_tools-nvc-extra_flags"></span>
                        </div>
                        <div class="setting-item-description">Comma separated values</div>
                        <input class="setting-input-box" id="tools-nvc-extra_flags">
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-checkbox">
                            <input type="checkbox" id="tools-nvc-bind_checks">
                            <label class="setting-checkbox-label" for="tools-nvc-bind_checks">
                                Enable binding checks during elaboration:
                                <span class="markConfig" id="mark_tools-nvc-bind_checks"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-checkbox">
                            <input type="checkbox" id="tools-nvc-vital_checks">
                            <label class="setting-checkbox-label" for="tools-nvc-vital_checks">
                                Enable VITAL compliance checks:
                                <span class="markConfig" id="mark_tools-nvc-vital_checks"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Simulation time limit (e.g., 1us, 100ns, 1ms). Leave empty for no limit.
                            <span class="markConfig" id="mark_tools-nvc-simulation_time"></span>
                        </div>
                            <input class="setting-input-box" id="tools-nvc-simulation_time" value="">
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Time resolution limit (e.g., 1ps, 1ns, 1us):
                            <span class="markConfig" id="mark_tools-nvc-resolution_limit"></span>
                        </div>
                            <input class="setting-input-box" id="tools-nvc-resolution_limit" value="">
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Stack size for simulation (e.g., 1MB, 16MB, 64MB). Leave empty for default.
                            <span class="markConfig" id="mark_tools-nvc-stack_size"></span>
                        </div>
                            <input class="setting-input-box" id="tools-nvc-stack_size" value="">
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Stop simulation after N delta cycles (--stop-delta):
                            <span class="markConfig" id="mark_tools-nvc-stop_delta_cycles"></span>
                        </div>
                        <input type="number" class="setting-number-input" id="tools-nvc-stop_delta_cycles">
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-checkbox">
                            <input type="checkbox" id="tools-nvc-waveform_enabled">
                            <label class="setting-checkbox-label" for="tools-nvc-waveform_enabled">
                                Enable waveform generation during simulation:
                                <span class="markConfig" id="mark_tools-nvc-waveform_enabled"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Waveform output format:
                            <span class="markConfig" id="mark_tools-nvc-waveform_format"></span>
                        </div>
                        <div class="select-container">
                            <select class="setting-select-box" id="tools-nvc-waveform_format">
                                      <option value='vcd'>VCD</option>
                                      <option value='ghw'>GHW</option>
                                      <option value='fst'>FST</option>
                            </select>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Additional waveform generation options (e.g., --vcd-4states, --wave-start-time=0ns):
                            <span class="markConfig" id="mark_tools-nvc-waveform_options"></span>
                        </div>
                        <div class="setting-item-description">Comma separated values</div>
                        <input class="setting-input-box" id="tools-nvc-waveform_options">
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Start time for waveform recording (e.g., 0ns, 10us):
                            <span class="markConfig" id="mark_tools-nvc-wave_start_time"></span>
                        </div>
                            <input class="setting-input-box" id="tools-nvc-wave_start_time" value="">
                    </div>
                  
                  
                    <div class="setting-item">
                        <div class="setting-checkbox">
                            <input type="checkbox" id="tools-nvc-vcd_4states">
                            <label class="setting-checkbox-label" for="tools-nvc-vcd_4states">
                                Use 4-state VCD format (--vcd-4states):
                                <span class="markConfig" id="mark_tools-nvc-vcd_4states"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-checkbox">
                            <input type="checkbox" id="tools-nvc-vcd_nodate">
                            <label class="setting-checkbox-label" for="tools-nvc-vcd_nodate">
                                Do not write date in VCD file (--vcd-nodate):
                                <span class="markConfig" id="mark_tools-nvc-vcd_nodate"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Wave option file for signal filtering (--read-wave-opt):
                            <span class="markConfig" id="mark_tools-nvc-read_wave_opt"></span>
                        </div>
                            <input class="setting-input-box" id="tools-nvc-read_wave_opt" value="">
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Create wave option file with all signals (--write-wave-opt):
                            <span class="markConfig" id="mark_tools-nvc-write_wave_opt"></span>
                        </div>
                            <input class="setting-input-box" id="tools-nvc-write_wave_opt" value="">
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Debug information level:
                            <span class="markConfig" id="mark_tools-nvc-debug_level"></span>
                        </div>
                        <div class="select-container">
                            <select class="setting-select-box" id="tools-nvc-debug_level">
                                      <option value='none'>No debug info</option>
                                      <option value='minimal'>Minimal debug info</option>
                                      <option value='full'>Full debug info</option>
                            </select>
                    ...
                    <div class="setting-item">
                        <div class="setting-checkbox">
                            <input type="checkbox" id="tools-nvc-verbose">
                            <label class="setting-checkbox-label" for="tools-nvc-verbose">
                                Enable verbose output for all NVC commands:
                                <span class="markConfig" id="mark_tools-nvc-verbose"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-checkbox">
                            <input type="checkbox" id="tools-nvc-warnings_as_errors">
                            <label class="setting-checkbox-label" for="tools-nvc-warnings_as_errors">
                                Treat warnings as errors:
                                <span class="markConfig" id="mark_tools-nvc-warnings_as_errors"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Warning types to suppress (e.g., binding, elaboration, runtime):
                            <span class="markConfig" id="mark_tools-nvc-suppress_warnings"></span>
                        </div>
                        <div class="setting-item-description">Comma separated values</div>
                        <input class="setting-input-box" id="tools-nvc-suppress_warnings">
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Assertion severity level:
                            <span class="markConfig" id="mark_tools-nvc-assert_level"></span>
                        </div>
                        <div class="select-container">
                            <select class="setting-select-box" id="tools-nvc-assert_level">
                                      <option value='note'>Note level</option>
                                      <option value='warning'>Warning level</option>
                                      <option value='error'>Error level</option>
                                      <option value='failure'>Failure level</option>
                    ...
                    <div class="setting-item">
                        <div class="setting-checkbox">
                            <input type="checkbox" id="tools-nvc-display_time">
                            <label class="setting-checkbox-label" for="tools-nvc-display_time">
                                Display time and delta cycle number (--disp-time):
                                <span class="markConfig" id="mark_tools-nvc-display_time"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-checkbox">
                            <input type="checkbox" id="tools-nvc-unbuffered_output">
                            <label class="setting-checkbox-label" for="tools-nvc-unbuffered_output">
                                Disable buffering on stdout (--unbuffered):
                                <span class="markConfig" id="mark_tools-nvc-unbuffered_output"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Maximum stack allocation size in KB (--max-stack-alloc, 0 to disable):
                            <span class="markConfig" id="mark_tools-nvc-max_stack_alloc"></span>
                        </div>
                        <input type="number" class="setting-number-input" id="tools-nvc-max_stack_alloc">
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Minimum severity level for backtrace on assert/report:
                            <span class="markConfig" id="mark_tools-nvc-backtrace_severity"></span>
                        </div>
                        <div class="select-container">
                            <select class="setting-select-box" id="tools-nvc-backtrace_severity">
                                      <option value='note'>Note level</option>
                                      <option value='warning'>Warning level</option>
                                      <option value='error'>Error level</option>
                                      <option value='failure'>Failure level</option>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Control IEEE assertion handling:
                            <span class="markConfig" id="mark_tools-nvc-ieee_asserts"></span>
                        </div>
                        <div class="select-container">
                            <select class="setting-select-box" id="tools-nvc-ieee_asserts">
                                      <option value='enable'>Enable IEEE assertions</option>
                                      <option value='disable'>Disable IEEE assertions</option>
                                      <option value='disable-at-0'>Disable at time 0</option>
                            </select>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Policy for handling assertions:
                            <span class="markConfig" id="mark_tools-nvc-asserts_policy"></span>
                        </div>
                        <div class="select-container">
                            <select class="setting-select-box" id="tools-nvc-asserts_policy">
                                      <option value='enable'>Enable assertions</option>
                                      <option value='disable'>Disable assertions</option>
                                      <option value='disable-at-0'>Disable at time 0</option>
                            </select>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            SDF file for timing annotation (--sdf):
                            <span class="markConfig" id="mark_tools-nvc-sdf_file"></span>
                        </div>
                            <input class="setting-input-box" id="tools-nvc-sdf_file" value="">
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            VPI modules to load (--vpi):
                            <span class="markConfig" id="mark_tools-nvc-vpi_modules"></span>
                        </div>
                        <div class="setting-item-description">Comma separated values</div>
                        <input class="setting-input-box" id="tools-nvc-vpi_modules">
                    </div>
                  
                    <div class="setting-item">
                        <div class="setting-item-label">
                            VHPI modules to load (--vhpi):
                            <span class="markConfig" id="mark_tools-nvc-vhpi_modules"></span>
                        </div>
                        <div class="setting-item-description">Comma separated values</div>
                        <input class="setting-input-box" id="tools-nvc-vhpi_modules">
                    </div>
                  
                    <div class="setting-item">
                        <div class="setting-item-label">
                            VPI trace output file (--vpi-trace):
                            <span class="markConfig" id="mark_tools-nvc-vpi_trace_file"></span>
                        </div>
                            <input class="setting-input-box" id="tools-nvc-vpi_trace_file" value="">
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            VHPI trace output file (--vhpi-trace):
                            <span class="markConfig" id="mark_tools-nvc-vhpi_trace_file"></span>
                        </div>
                            <input class="setting-input-box" id="tools-nvc-vhpi_trace_file" value="">
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            PSL report output file (--psl-report):
                            <span class="markConfig" id="mark_tools-nvc-psl_report_file"></span>
                        </div>
                            <input class="setting-input-box" id="tools-nvc-psl_report_file" value="">
                    </div>
                  
                  
                    <div class="setting-item">
                        <div class="setting-checkbox">
                            <input type="checkbox" id="tools-nvc-psl_report_uncovered">
                            <label class="setting-checkbox-label" for="tools-nvc-psl_report_uncovered">
                                Report uncovered PSL cover points (--psl-report-uncovered):
                                <span class="markConfig" id="mark_tools-nvc-psl_report_uncovered"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="setting-item">
                        <div class="setting-item-label">
                            Display design hierarchy (--disp-tree):
                            <span class="markConfig" id="mark_tools-nvc-disp_tree"></span>
                        </div>
                        <div class="select-container">
                            <select class="setting-select-box" id="tools-nvc-disp_tree">
                                      <option value='none'>No hierarchy display</option>
                                      <option value='inst'>Display instances</option>
                                      <option value='proc'>Display processes</option>
                                      <option value='port'>Display ports and signals</option>
                    ...
                    <div class="setting-item">
                        <div class="setting-checkbox">
                            <input type="checkbox" id="tools-nvc-no_run">
                            <label class="setting-checkbox-label" for="tools-nvc-no_run">
                                Elaborate but do not run simulation:
                                <span class="markConfig" id="mark_tools-nvc-no_run"></span>
                            </label>
                        </div>
                    </div>
...
<script>
  ...
  function enable_tab(tp0, tp1){
    ...
    document.getElementById("tools-nvc").classList.remove('active');
  ...
  function updateSidebarSelection(tp0, tp1) {
    ...
    if (document.getElementById("btn-tools-nvc")) {
        document.getElementById("btn-tools-nvc").classList.remove('selected');
    }
  ...
  if (document.getElementById("btn-tools-nvc")) {
    document.getElementById("btn-tools-nvc").addEventListener("click", function(e) {
      e.preventDefault();
  ...
  function get_config(){
    ...
    config["tools"]["nvc"] = {}
    config["tools"]["nvc"]["section_basic"] = element_value
    element_value = document.getElementById("tools-nvc-installation_path").value;
    config["tools"]["nvc"]["installation_path"] = element_value
    config["tools"]["nvc"]["section_language"] = element_value
    element_value = document.getElementById("tools-nvc-vhdl_standard").value;
    config["tools"]["nvc"]["vhdl_standard"] = element_value
    element_value = document.getElementById("tools-nvc-ieee_library").value;
    config["tools"]["nvc"]["ieee_library"] = element_value
    element_value = document.getElementById("tools-nvc-relaxed_parsing").checked;
    config["tools"]["nvc"]["relaxed_parsing"] = element_value
    element_value = document.getElementById("tools-nvc-unicode_support").checked;
    config["tools"]["nvc"]["unicode_support"] = element_value
    element_value = document.getElementById("tools-nvc-psl_enabled").checked;
    config["tools"]["nvc"]["psl_enabled"] = element_value
    config["tools"]["nvc"]["section_libraries"] = element_value
    element_value = document.getElementById("tools-nvc-work_library").value;
    config["tools"]["nvc"]["work_library"] = element_value
    element_value = document.getElementById("tools-nvc-library_paths").value.split(',');
    if (element_value.length == 1 && element_value[0] == "") {
      element_value = [];
    }
    config["tools"]["nvc"]["library_paths"] = element_value
    config["tools"]["nvc"]["section_stage_options"] = element_value
    element_value = document.getElementById("tools-nvc-check_syntax_options").value.split(',');
    if (element_value.length == 1 && element_value[0] == "") {
      element_value = [];
    }
    config["tools"]["nvc"]["check_syntax_options"] = element_value
    element_value = document.getElementById("tools-nvc-analyze_options").value.split(',');
    if (element_value.length == 1 && element_value[0] == "") {
      element_value = [];
    }
    config["tools"]["nvc"]["analyze_options"] = element_value
    element_value = document.getElementById("tools-nvc-elaborate_options").value.split(',');
    if (element_value.length == 1 && element_value[0] == "") {
      element_value = [];
    }
    config["tools"]["nvc"]["elaborate_options"] = element_value
    element_value = document.getElementById("tools-nvc-run_options").value.split(',');
    if (element_value.length == 1 && element_value[0] == "") {
      element_value = [];
    }
    config["tools"]["nvc"]["run_options"] = element_value
    element_value = document.getElementById("tools-nvc-synthesis_options").value.split(',');
    if (element_value.length == 1 && element_value[0] == "") {
      element_value = [];
    }
    config["tools"]["nvc"]["synthesis_options"] = element_value
    config["tools"]["nvc"]["section_custom"] = element_value
    element_value = document.getElementById("tools-nvc-extra_flags").value.split(',');
    if (element_value.length == 1 && element_value[0] == "") {
      element_value = [];
    }
    config["tools"]["nvc"]["extra_flags"] = element_value
    config["tools"]["nvc"]["section_elaboration"] = element_value
    element_value = document.getElementById("tools-nvc-relaxed_rules").checked;
    config["tools"]["nvc"]["relaxed_rules"] = element_value
    element_value = document.getElementById("tools-nvc-bind_checks").checked;
    config["tools"]["nvc"]["bind_checks"] = element_value
    element_value = document.getElementById("tools-nvc-vital_checks").checked;
    config["tools"]["nvc"]["vital_checks"] = element_value
    config["tools"]["nvc"]["section_simulation"] = element_value
    element_value = document.getElementById("tools-nvc-simulation_time").value;
    config["tools"]["nvc"]["simulation_time"] = element_value
    element_value = document.getElementById("tools-nvc-resolution_limit").value;
    config["tools"]["nvc"]["resolution_limit"] = element_value
    element_value = document.getElementById("tools-nvc-stack_size").value;
    config["tools"]["nvc"]["stack_size"] = element_value
    element_value = parseInt(document.getElementById("tools-nvc-stop_delta_cycles").value, 10);
    config["tools"]["nvc"]["stop_delta_cycles"] = element_value
    config["tools"]["nvc"]["section_waveform"] = element_value
    element_value = document.getElementById("tools-nvc-waveform_enabled").checked;
    config["tools"]["nvc"]["waveform_enabled"] = element_value
    element_value = document.getElementById("tools-nvc-waveform_format").value;
    config["tools"]["nvc"]["waveform_format"] = element_value
    element_value = document.getElementById("tools-nvc-waveform_options").value.split(',');
    if (element_value.length == 1 && element_value[0] == "") {
      element_value = [];
    }
    config["tools"]["nvc"]["waveform_options"] = element_value
    config["tools"]["nvc"]["section_waveform_advanced"] = element_value
    element_value = document.getElementById("tools-nvc-wave_start_time").value;
    config["tools"]["nvc"]["wave_start_time"] = element_value
    element_value = document.getElementById("tools-nvc-vcd_4states").checked;
    config["tools"]["nvc"]["vcd_4states"] = element_value
    element_value = document.getElementById("tools-nvc-vcd_nodate").checked;
    config["tools"]["nvc"]["vcd_nodate"] = element_value
    element_value = document.getElementById("tools-nvc-read_wave_opt").value;
    config["tools"]["nvc"]["read_wave_opt"] = element_value
    element_value = document.getElementById("tools-nvc-write_wave_opt").value;
    config["tools"]["nvc"]["write_wave_opt"] = element_value
    config["tools"]["nvc"]["section_debug"] = element_value
    element_value = document.getElementById("tools-nvc-debug_level").value;
    config["tools"]["nvc"]["debug_level"] = element_value
    element_value = document.getElementById("tools-nvc-verbose").checked;
    config["tools"]["nvc"]["verbose"] = element_value
    config["tools"]["nvc"]["section_warnings"] = element_value
    element_value = document.getElementById("tools-nvc-warnings_as_errors").checked;
    config["tools"]["nvc"]["warnings_as_errors"] = element_value
    element_value = document.getElementById("tools-nvc-suppress_warnings").value.split(',');
    if (element_value.length == 1 && element_value[0] == "") {
      element_value = [];
    }
    config["tools"]["nvc"]["suppress_warnings"] = element_value
    config["tools"]["nvc"]["section_assertions"] = element_value
    element_value = document.getElementById("tools-nvc-assert_level").value;
    config["tools"]["nvc"]["assert_level"] = element_value
    config["tools"]["nvc"]["section_display"] = element_value
    element_value = document.getElementById("tools-nvc-display_time").checked;
    config["tools"]["nvc"]["display_time"] = element_value
    element_value = document.getElementById("tools-nvc-unbuffered_output").checked;
    config["tools"]["nvc"]["unbuffered_output"] = element_value
    element_value = parseInt(document.getElementById("tools-nvc-max_stack_alloc").value, 10);
    config["tools"]["nvc"]["max_stack_alloc"] = element_value
    config["tools"]["nvc"]["section_backtrace"] = element_value
    element_value = document.getElementById("tools-nvc-backtrace_severity").value;
    config["tools"]["nvc"]["backtrace_severity"] = element_value
    config["tools"]["nvc"]["section_ieee"] = element_value
    element_value = document.getElementById("tools-nvc-ieee_asserts").value;
    config["tools"]["nvc"]["ieee_asserts"] = element_value
    element_value = document.getElementById("tools-nvc-asserts_policy").value;
    config["tools"]["nvc"]["asserts_policy"] = element_value
    config["tools"]["nvc"]["section_external"] = element_value
    element_value = document.getElementById("tools-nvc-sdf_file").value;
    config["tools"]["nvc"]["sdf_file"] = element_value
    element_value = document.getElementById("tools-nvc-vpi_modules").value.split(',');
    if (element_value.length == 1 && element_value[0] == "") {
      element_value = [];
    }
    config["tools"]["nvc"]["vpi_modules"] = element_value
    element_value = document.getElementById("tools-nvc-vhpi_modules").value.split(',');
    if (element_value.length == 1 && element_value[0] == "") {
      element_value = [];
    }
    config["tools"]["nvc"]["vhpi_modules"] = element_value
    element_value = document.getElementById("tools-nvc-vpi_trace_file").value;
    config["tools"]["nvc"]["vpi_trace_file"] = element_value
    element_value = document.getElementById("tools-nvc-vhpi_trace_file").value;
    config["tools"]["nvc"]["vhpi_trace_file"] = element_value
    config["tools"]["nvc"]["section_tracing"] = element_value
    element_value = document.getElementById("tools-nvc-psl_report_file").value;
    config["tools"]["nvc"]["psl_report_file"] = element_value
    element_value = document.getElementById("tools-nvc-psl_report_uncovered").checked;
    config["tools"]["nvc"]["psl_report_uncovered"] = element_value
    element_value = document.getElementById("tools-nvc-disp_tree").value;
    config["tools"]["nvc"]["disp_tree"] = element_value
    config["tools"]["nvc"]["section_execution"] = element_value
    element_value = document.getElementById("tools-nvc-no_run").checked;
    config["tools"]["nvc"]["no_run"] = element_value
    config["tools"]["icarus"] = {}
  ...
  function set_config(config){
    ...
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["installation_path"] !== undefined) {
        document.getElementById("tools-nvc-installation_path").value = config["tools"]["nvc"]["installation_path"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["vhdl_standard"] !== undefined) {
        document.getElementById("tools-nvc-vhdl_standard").value = config["tools"]["nvc"]["vhdl_standard"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["ieee_library"] !== undefined) {
        document.getElementById("tools-nvc-ieee_library").value = config["tools"]["nvc"]["ieee_library"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["relaxed_parsing"] !== undefined) {
        document.getElementById("tools-nvc-relaxed_parsing").checked = config["tools"]["nvc"]["relaxed_parsing"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["unicode_support"] !== undefined) {
        document.getElementById("tools-nvc-unicode_support").checked = config["tools"]["nvc"]["unicode_support"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["psl_enabled"] !== undefined) {
        document.getElementById("tools-nvc-psl_enabled").checked = config["tools"]["nvc"]["psl_enabled"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["work_library"] !== undefined) {
        document.getElementById("tools-nvc-work_library").value = config["tools"]["nvc"]["work_library"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["library_paths"] !== undefined) {
        element_value = document.getElementById("tools-nvc-library_paths").value = String(config["tools"]["nvc"]["library_paths"]);
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["check_syntax_options"] !== undefined) {
        element_value = document.getElementById("tools-nvc-check_syntax_options").value = String(config["tools"]["nvc"]["check_syntax_options"]);
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["analyze_options"] !== undefined) {
        element_value = document.getElementById("tools-nvc-analyze_options").value = String(config["tools"]["nvc"]["analyze_options"]);
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["elaborate_options"] !== undefined) {
        element_value = document.getElementById("tools-nvc-elaborate_options").value = String(config["tools"]["nvc"]["elaborate_options"]);
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["run_options"] !== undefined) {
        element_value = document.getElementById("tools-nvc-run_options").value = String(config["tools"]["nvc"]["run_options"]);
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["synthesis_options"] !== undefined) {
        element_value = document.getElementById("tools-nvc-synthesis_options").value = String(config["tools"]["nvc"]["synthesis_options"]);
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["extra_flags"] !== undefined) {
        element_value = document.getElementById("tools-nvc-extra_flags").value = String(config["tools"]["nvc"]["extra_flags"]);
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["relaxed_rules"] !== undefined) {
        document.getElementById("tools-nvc-relaxed_rules").checked = config["tools"]["nvc"]["relaxed_rules"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["bind_checks"] !== undefined) {
        document.getElementById("tools-nvc-bind_checks").checked = config["tools"]["nvc"]["bind_checks"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["vital_checks"] !== undefined) {
        document.getElementById("tools-nvc-vital_checks").checked = config["tools"]["nvc"]["vital_checks"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["simulation_time"] !== undefined) {
        document.getElementById("tools-nvc-simulation_time").value = config["tools"]["nvc"]["simulation_time"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["resolution_limit"] !== undefined) {
        document.getElementById("tools-nvc-resolution_limit").value = config["tools"]["nvc"]["resolution_limit"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["stack_size"] !== undefined) {
        document.getElementById("tools-nvc-stack_size").value = config["tools"]["nvc"]["stack_size"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["stop_delta_cycles"] !== undefined) {
        document.getElementById("tools-nvc-stop_delta_cycles").value = config["tools"]["nvc"]["stop_delta_cycles"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["waveform_enabled"] !== undefined) {
        document.getElementById("tools-nvc-waveform_enabled").checked = config["tools"]["nvc"]["waveform_enabled"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["waveform_format"] !== undefined) {
        document.getElementById("tools-nvc-waveform_format").value = config["tools"]["nvc"]["waveform_format"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["waveform_options"] !== undefined) {
        element_value = document.getElementById("tools-nvc-waveform_options").value = String(config["tools"]["nvc"]["waveform_options"]);
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["wave_start_time"] !== undefined) {
        document.getElementById("tools-nvc-wave_start_time").value = config["tools"]["nvc"]["wave_start_time"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["vcd_4states"] !== undefined) {
        document.getElementById("tools-nvc-vcd_4states").checked = config["tools"]["nvc"]["vcd_4states"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["vcd_nodate"] !== undefined) {
        document.getElementById("tools-nvc-vcd_nodate").checked = config["tools"]["nvc"]["vcd_nodate"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["read_wave_opt"] !== undefined) {
        document.getElementById("tools-nvc-read_wave_opt").value = config["tools"]["nvc"]["read_wave_opt"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["write_wave_opt"] !== undefined) {
        document.getElementById("tools-nvc-write_wave_opt").value = config["tools"]["nvc"]["write_wave_opt"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["debug_level"] !== undefined) {
        document.getElementById("tools-nvc-debug_level").value = config["tools"]["nvc"]["debug_level"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["verbose"] !== undefined) {
        document.getElementById("tools-nvc-verbose").checked = config["tools"]["nvc"]["verbose"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["warnings_as_errors"] !== undefined) {
        document.getElementById("tools-nvc-warnings_as_errors").checked = config["tools"]["nvc"]["warnings_as_errors"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["suppress_warnings"] !== undefined) {
        element_value = document.getElementById("tools-nvc-suppress_warnings").value = String(config["tools"]["nvc"]["suppress_warnings"]);
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["assert_level"] !== undefined) {
        document.getElementById("tools-nvc-assert_level").value = config["tools"]["nvc"]["assert_level"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["display_time"] !== undefined) {
        document.getElementById("tools-nvc-display_time").checked = config["tools"]["nvc"]["display_time"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["unbuffered_output"] !== undefined) {
        document.getElementById("tools-nvc-unbuffered_output").checked = config["tools"]["nvc"]["unbuffered_output"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["max_stack_alloc"] !== undefined) {
        document.getElementById("tools-nvc-max_stack_alloc").value = config["tools"]["nvc"]["max_stack_alloc"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["backtrace_severity"] !== undefined) {
        document.getElementById("tools-nvc-backtrace_severity").value = config["tools"]["nvc"]["backtrace_severity"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["ieee_asserts"] !== undefined) {
        document.getElementById("tools-nvc-ieee_asserts").value = config["tools"]["nvc"]["ieee_asserts"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["asserts_policy"] !== undefined) {
        document.getElementById("tools-nvc-asserts_policy").value = config["tools"]["nvc"]["asserts_policy"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["sdf_file"] !== undefined) {
        document.getElementById("tools-nvc-sdf_file").value = config["tools"]["nvc"]["sdf_file"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["vpi_modules"] !== undefined) {
        element_value = document.getElementById("tools-nvc-vpi_modules").value = String(config["tools"]["nvc"]["vpi_modules"]);
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["vhpi_modules"] !== undefined) {
        element_value = document.getElementById("tools-nvc-vhpi_modules").value = String(config["tools"]["nvc"]["vhpi_modules"]);
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["vpi_trace_file"] !== undefined) {
        document.getElementById("tools-nvc-vpi_trace_file").value = config["tools"]["nvc"]["vpi_trace_file"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["vhpi_trace_file"] !== undefined) {
        document.getElementById("tools-nvc-vhpi_trace_file").value = config["tools"]["nvc"]["vhpi_trace_file"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["psl_report_file"] !== undefined) {
        document.getElementById("tools-nvc-psl_report_file").value = config["tools"]["nvc"]["psl_report_file"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["psl_report_uncovered"] !== undefined) {
        document.getElementById("tools-nvc-psl_report_uncovered").checked = config["tools"]["nvc"]["psl_report_uncovered"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["disp_tree"] !== undefined) {
        document.getElementById("tools-nvc-disp_tree").value = config["tools"]["nvc"]["disp_tree"];
    }
    if (config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["no_run"] !== undefined) {
        document.getElementById("tools-nvc-no_run").checked = config["tools"]["nvc"]["no_run"];
    }
  ...
  function set_mark(config, projectName){
    ...
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["installation_path"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-installation_path").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["vhdl_standard"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-vhdl_standard").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["ieee_library"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-ieee_library").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["relaxed_parsing"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-relaxed_parsing").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["unicode_support"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-unicode_support").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["psl_enabled"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-psl_enabled").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["work_library"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-work_library").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["library_paths"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-library_paths").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["check_syntax_options"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-check_syntax_options").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["analyze_options"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-analyze_options").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["elaborate_options"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-elaborate_options").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["run_options"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-run_options").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["synthesis_options"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-synthesis_options").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["extra_flags"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-extra_flags").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["relaxed_rules"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-relaxed_rules").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["bind_checks"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-bind_checks").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["vital_checks"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-vital_checks").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["simulation_time"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-simulation_time").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["resolution_limit"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-resolution_limit").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["stack_size"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-stack_size").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["stop_delta_cycles"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-stop_delta_cycles").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["waveform_enabled"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-waveform_enabled").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["waveform_format"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-waveform_format").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["waveform_options"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-waveform_options").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["wave_start_time"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-wave_start_time").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["vcd_4states"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-vcd_4states").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["vcd_nodate"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-vcd_nodate").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["read_wave_opt"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-read_wave_opt").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["write_wave_opt"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-write_wave_opt").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["debug_level"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-debug_level").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["verbose"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-verbose").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["warnings_as_errors"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-warnings_as_errors").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["suppress_warnings"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-suppress_warnings").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["assert_level"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-assert_level").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["display_time"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-display_time").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["unbuffered_output"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-unbuffered_output").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["max_stack_alloc"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-max_stack_alloc").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["backtrace_severity"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-backtrace_severity").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["ieee_asserts"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-ieee_asserts").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["asserts_policy"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-asserts_policy").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["sdf_file"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-sdf_file").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["vpi_modules"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-vpi_modules").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["vhpi_modules"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-vhpi_modules").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["vpi_trace_file"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-vpi_trace_file").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["vhpi_trace_file"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-vhpi_trace_file").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["psl_report_file"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-psl_report_file").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["psl_report_uncovered"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-psl_report_uncovered").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["disp_tree"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-disp_tree").innerHTML = mark;
    mark = "";
    if (projectName !== undefined && config["tools"] && config["tools"]["nvc"] && config["tools"]["nvc"]["no_run"] !== undefined) {
      mark = MODIFIEDMSG;
    }
    document.getElementById("mark_tools-nvc-no_run").innerHTML = mark;
    mark = "";
