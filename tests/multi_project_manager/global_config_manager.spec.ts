...
async function importGlobalConfigManager() {
    ...
    jest.mock('../../src/colibri/config/config_declaration', () => ({
        ...jest.requireActual('../../src/colibri/config/config_declaration'),
    ...
    const module = await import("../../src/colibri/config/config_manager");
