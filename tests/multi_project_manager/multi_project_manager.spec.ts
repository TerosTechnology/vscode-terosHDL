...
import { Multi_project_manager } from '../../src/colibri/project_manager/multi_project_manager';
import { Project_manager } from '../../src/colibri/project_manager/project_manager';
import { QuartusProjectManager } from '../../src/colibri/project_manager/tool/quartus/quartusProjectManager';
import { save_file_sync, read_file_sync } from '../../src/colibri/utils/file_utils';
...
jest.mock('../../src/colibri/utils/file_utils', () => ({
    ...jest.requireActual('../../src/colibri/utils/file_utils'),
...
jest.mock('../../src/colibri/project_manager/project_manager', () => {
    const originalModule = jest.requireActual('../../src/colibri/project_manager/project_manager');
...
jest.mock('../../src/colibri/project_manager/tool/quartus/quartusProjectManager', () => {
    const originalModule = jest.requireActual('../../src/colibri/project_manager/tool/quartus/quartusProjectManager');
