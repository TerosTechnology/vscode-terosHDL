...
import * as common_documenter from "../../src/colibri/documenter/common";
import { Documenter } from "../../src/colibri/documenter/documenter";
import { LANGUAGE } from "../../src/colibri/common/general";
import * as common_process from "../../src/colibri/process/common";
import { get_os } from "../../src/colibri/process/utils";
import * as cfg from "../../src/colibri/config/config_declaration";
import { t_documenter_options } from "../../src/colibri/config/auxiliar_config";
import { normalize_breakline_windows } from "../../src/colibri/utils/common_utils";
import { read_file_sync } from '../../src/colibri/utils/file_utils';
